...
<x-web-app.dashboard.dashboard-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories' :all_opportunities='$all_opportunities' :user_details='$user_details'>
    ...
    <form method="GET" class="mb-2">
        <div class="input-group mb-3">
            <input type="text" name="search" value="{{ request()->get('search') }}" class="form-control" placeholder="Search Opportunities ..." aria-label="Search Opportunities" aria-describedby="button-addon2">
            <button class="btn color-bg" style="text-align: right !important;" type="submit" id="button-addon2">
                <span>
                    <i class="fal fa-search" style="color: #ffffff !important;"></i> Search
                </span>
            </button>
        </div>
    </form>
    <table class="table table-bordered styled-table">
        <thead>
            <tr>
                <th class="tb_index_column_th">#</th>
                <th>Title</th>
                <th>Owner</th>
                <th>Category</th>
                <th>Country</th>
                <th>Status</th>
                <th class="tb_last_column_th">Action</th>
            </tr>
        </thead>
        <tbody>
