            ...
            <ul class="no-list-style">
                <li>
                    <div class="widget-posts-img">
                        <a href="listing-single.html">
                            <img src="{{ asset('web_app/images/gallery/thumbnail/1.png') }}" alt="">
                        </a>
                    </div>
                    <div class="widget-posts-descr">
                        ...
                        <div class="geodir-category-location fl-wrap">
                            <a href="#"><i class="fas fa-map-marker-alt"></i> 40 Journal Square Plaza, NJ, USA</a>
                        </div>
                        <div class="widget-posts-descr-link">
                            <a href="opportunities.html" >Restaurants </a>   <a href="opportunities.html">Cafe</a>
                        </div>
                ...
                <li>
                    ...
                    <div class="widget-posts-descr">
                        ...
                        <div class="widget-posts-descr-link">
                            <a href="opportunities.html" >Hotels </a>
                        </div>
                    ...
                    <div class="widget-posts-descr">
                        ...
                        <div class="geodir-category-location fl-wrap">
                            <a href="#"><i class="fas fa-map-marker-alt">
                                </i>75 Prince St, NY, USA
                            </a>
                        </div>
                        <div class="widget-posts-descr-link">
                            <a href="opportunities.html" >Events</a>
                        </div>
                ...
                <li>
                    ...
                    <div class="widget-posts-descr">
                        ...
                        <div class="geodir-category-location fl-wrap">
                            <a href="#">
                                <i class="fas fa-map-marker-alt"></i> W 85th St, New York, USA
                            </a>
                        </div>
                        <div class="widget-posts-descr-link">
                            <a href="opportunities.html" >Fitness</a> <a href="opportunities.html" >Gym</a>
                        </div>
                        <div class="widget-posts-descr-score">5.0</div>
                        <div class="clear-wishlist">
                            <i class="fal fa-times-circle"></i>
