        ...
        <div class="show-lang" style="width: 120px !important; margin-top: 3px !important;  margin-right: 5px !important; border: 0px solid white !important;">
            <span>
                ...
                @if (Auth::user()->is_admin === 1)
                    ...
                    <a href="{{ route('admin-app.dashboard.admin-main-dashboard', $user_id) }}" class="dashboard_link {{ ($current_route == "admin-app.dashboard." || in_array($current_route, $dashbaord_routes)) ? 'dashboard-act-link' : '' }}" >
