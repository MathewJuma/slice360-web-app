...
<div class="show-reg-form">
    <a href="{{ route('web-app.dashboard.show-user-profile', $user_id) }}" class="dashboard_link {{ ($current_route == "web-app.dashboard.show-user-profile" && $user_details->id === session()->get('system_user_id')) ? 'dashboard-act-link' : '' }}"">
