@php
    ...
    //routes array
    $dashbaord_routes = [
        "web-app.dashboard.show-user-profile",
...
<div class="lang-wrap">
    <div class="show-lang" style="width: 120px !important; margin-top: 3px !important;  margin-right: 5px !important; border: 0px solid white !important;">
        <span>
            <a href="{{ route('web-app.dashboard.main-dashboard', $user_id) }}" class="dashboard_link {{ $current_route == "web-app.dashboard.main-dashboard" ? 'dashboard-act-link' : '' }}" >
