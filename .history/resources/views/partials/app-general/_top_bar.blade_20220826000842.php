...
<div class="nav-holder main-menu">
    <nav>
        <ul class="no-list-style">
            ...
            <li>
                <a href="/opportunities" class="{{ ($current_route == "web-app.opportunities.list-opportunities" || $current_route == "web-app.opportunities.show-opportunities") ? 'act-link' : '' }}">Opportunities</a>
            </li>
            <li>
