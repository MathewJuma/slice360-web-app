...
<html lang="en">
    <head>
        ...
        <!--=============== fonts  ===============-->
        <!--<link type="text/css" rel="stylesheet" href="css/font_awesome/all.css">-->
        <link type="text/css" rel="stylesheet" href="css/font_awesome/brands.css">
        <link type="text/css" rel="stylesheet" href="css/font_awesome/font_awesome.css">
        <link type="text/css" rel="stylesheet" href="css/font_awesome/regular.css">
        <!--<link type="text/css" rel="stylesheet" href="css/font_awesome/solid.css">-->
        <link type="text/css" rel="stylesheet" href="css/font_awesome/svg-with-js.css">
        <link type="text/css" rel="stylesheet" href="css/font_awesome/v4-shims.css">
        <!--<link type="text/css" rel="stylesheet" href="css/font_awesome/v4-font-face.css">-->
        <!--<link type="text/css" rel="stylesheet" href="css/font_awesome/v5-font-face.css">-->
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <a href="index.html" class="logo-holder">
                    <img src="images/logo.png" class="logo-image" alt="slice360">
            ...
            <div id="wrapper">
                ...
                <div class="content">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms-item_fs fl-wrap full-height">
                                                    <div class="bg" data-bg="images/bg/agriculture.jpg"></div>
                                            ...
                                            <div class="swiper-slide ">
                                                <div class="ms-item_fs fl-wrap full-height">
                                                    <div class="bg" data-bg="images/bg/real_estate.jpg"></div>
                                                    <div class="overlay op7"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms-item_fs fl-wrap full-height">
                                                    <div class="bg" data-bg="images/bg/energy.jpg"></div>
                                                    <div class="overlay op7"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->
                                                ...
                                                <div class="listing-item listing_carditem">
                                                    <article class="geodir-category-listing fl-wrap">
                                                        <div class="geodir-category-img">
                                                            ...
                                                            <img src="images/all/land_for_sale.jpg" alt="">
                                                            </a>
                                                            ...
                                                            <div class="geodir-category-opt">
                                                                ...
                                                                <div class="listing_carditem_footer fl-wrap">
                                                                    ...
                                                                    <div class="post-author"><a href="#"><img src="images/avatar/1.jpg" alt=""><span>By , Mathew Juma</span></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
                                                ...
                                                <div class="listing-item listing_carditem">
                                                    <article class="geodir-category-listing fl-wrap">
                                                        <div class="geodir-category-img">
                                                            <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                            <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                            <img src="images/all/gym_fitness.jpg" alt="">
                                                            </a>
                                                ...
                                                <div class="listing-item listing_carditem">
                                                    <article class="geodir-category-listing fl-wrap">
                                                        <div class="geodir-category-img">
                                                            <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                            <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                            <img src="images/all/hotel.jpg" alt="">
                                                            </a>
                                                            <div class="geodir_status_date gsd_open"><i class="fal fa-lock-open"></i>Open Now</div>
                                                            <div class="geodir-category-opt">
                                                                <div class="geodir-category-opt_title">
                                                ...
                                                <div class="listing-item listing_carditem">
                                                    <article class="geodir-category-listing fl-wrap">
                                                        <div class="geodir-category-img">
                                                            <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                            <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                            <img src="images/all/shell_petrol.jpg" alt="">
                                                            </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/agriculture.jpg"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/real_estate.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/energy.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/education.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/transport.jpg"></div>
                                            <div class="d-gr-sec"></div>
                    ...
                    <section class="parallax-section small-par" data-scrollax-parent="true">
                        <div class="bg par-elem "  data-bg="images/bg/statistics.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                        <div class="overlay  op7"></div>
                        <div class="container">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-wheat.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-gas-station.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-bus-transport.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-race-track.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-gym.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-apartment.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <div class="geodir-js-favorite_btn"><i class="fal fa-heart"></i><span>Save</span></div>
                                                <a href="listing-luxury-restaurant.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="images/all/item-layers.jpg" alt="">
                                                </a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                    ...
                    <section class="parallax-section" data-scrollax-parent="true">
                        <div class="bg par-elem "  data-bg="images/bg/video-bg.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                        <div class="overlay op7"></div>
                        <!--container-->
                        <div class="container">
