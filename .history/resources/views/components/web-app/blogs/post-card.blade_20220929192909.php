...
<article class="post-article">
    ...
    <div class="list-single-main-item fl-wrap block_box">
        <h2 class="post-opt-title">
            <a href="{{ route('web-app.blog.blog-single', $post->id) }}">{{ $post->title }}</a>
        </h2>
        <p style="text-align: justify !important; color: #878c9f !important;">{!! $post->excerpt !!}</p>
        ...
        <a href="{{ route('web-app.blog.blog-single', $post->sid) }}" class="btn color2-bg  float-btn general-btn">
