        ...
        <div class="geodir-category-img">
            ...
            @if ($current_route != 'web-app.dashboard.show-user-profile')
                <div class="listing-avatar">
                    ...
                    @endif
                    <span class="avatar-tooltip" style="min-width: 275px; margin-top: -3px !important;">Added By
                        <a href="{{ $opportunity_user_path }}">
                            <strong>
            ...
            <div class="geodir-category-opt">
                <div class="listing-rating-count-wrap">
                    ...
                    <div class="reviews-count">
                        {{ views($opportunity)->count() }}&nbsp;&nbsp;view{{ views($opportunity)->count() > 1 ? 's' : '' }}&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/opportunities/{{ $opportunity->id }}-{{ Str::slug($opportunity->title) }}#opportunity_reviews" class="normal_link"><span>{{ $total_reviews }}&nbsp;&nbsp;review{{ $total_reviews > 1 ? 's' : '' }}</span></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="geodir-category-content fl-wrap title-sin_item" style="margin-top: 10px !important;">
            ...
            <div class="geodir-category-text fl-wrap">
                ...
                <div class="facilities-list fl-wrap">
                    <div class="facilities-list-title">Opportunity seeking:</div>
                    <ul class="no-list-style" style="text-align: right !important; padding-right: 10px !important;">
                        {!! $opportunity_seek !!}
                    </ul>
                </div>
            </div>
