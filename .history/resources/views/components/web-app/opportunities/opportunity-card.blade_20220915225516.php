            ...
            <div class="geodir-category-opt">
                <div class="listing-rating-count-wrap">
                    ...
                    <div class="reviews-count">
                        {{ views($opportunity)->count() }}&nbsp;&nbsp;views&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/opportunities/{{ $opportunity->id }}-{{ Str::slug($opportunity->title) }}#opportunity_reviews" class="normal_link"><span>{{ $total_reviews }}&nbsp;&nbsp;reviews</span></a>
                    </div>
                </div>
            </div>
        </div>
