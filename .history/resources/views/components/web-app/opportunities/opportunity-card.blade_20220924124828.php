            ...
            <div class="geodir-category-content-title fl-wrap">
                <div class="geodir-category-content-title-item">
                    <h3 class="title-sin_map">
                        ...
                        {{-- show if opportunity is verified --}}
                        @if ($opportunity->is_verified === "Yes")
                            <span class="verified-badge tolt" data-microtip-position="bottom" data-tooltip="verified">
                                <i class="fal fa-check"></i>
                            </span>
                        @else
                            <span class="verified-badge tolt" data-microtip-position="bottom" data-tooltip="not verified">
                                <i class="fal fa-exclamation"></i>
                            </span>
                        @endif
                        {{-- show if opportunity is verified end --}}
                    </h3>
