                ...
                <div class="geodir-category-opt">
                    <div class="listing-rating-count-wrap">
                        ...
                        <div class="reviews-count">
                            {{ $opportunity->views_count }}&nbsp;&nbsp;views{{ $total_reviews > 1 ? 's' : '' }}&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/opportunities/{{ $opportunity->id }}-{{ Str::slug($opportunity->title) }}#opportunity_reviews" class="normal_link"><span>{{ $total_reviews }}&nbsp;&nbsp;review{{ $total_reviews > 1 ? 's' : '' }}</span></a>
                        </div>
                    </div>
                </div>
            </div>
