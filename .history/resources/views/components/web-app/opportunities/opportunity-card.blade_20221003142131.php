            ...
            <div class="geodir-category-text fl-wrap">
                ...
                <div class="facilities-list fl-wrap">
                    ...
                    <ul class="no-list-style">
                        @php
                            $opportunity_gap = implode('<span class="funding-separator">&nbsp;&nbsp;|&nbsp;&nbsp;</span>', ['<span class="tolt finance-details">Investors</span>', '<span class="tolt finance-details">Donors</span>', '<span class="tolt finance-details">Incubation</span>']);
