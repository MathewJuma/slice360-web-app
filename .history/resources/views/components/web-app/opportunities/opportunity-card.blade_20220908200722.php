...
@php
    ...
    //check if this opportunity has a user profile
    if(isset($opportunity->opportunity_user->user_profile)){

        $user_profile = $opportunity->opportunity_user->user_profile;
        $user_profile_path = asset(route('web-app.dashboard.show-user-profile', $user_profile->id))

    }else{
        $user_profile = "";
        $user_profile_path = asset(route('web-app.dashboard.show-user-profile', '#'))
    }
