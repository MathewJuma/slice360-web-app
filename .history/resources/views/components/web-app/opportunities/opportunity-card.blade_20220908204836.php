...
@php
    ...
    //dd($opportunity->opportunity_user->user_profile);

    //check if this opportunity has a user
    if(isset($opportunity->opportunity_user)){

        $opportunity_user = $opportunity->opportunity_user;
        $opportunity_user_path = asset(route('web-app.dashboard.show-user-profile', $opportunity_user->id));

        //check is this profile has a user image
        if(isset($opportunity->opportunity_user->user_profile->user_profile_image)){

            $profile_image = asset($opportunity->opportunity_user->user_profile->user_profile_image->image_path);
            //$profile_image_path = asset(route('web-app.dashboard.show-user-profile', $opportunity_user->id));
        ...
        <div class="geodir-category-img">
            ...
            @if ($current_route != 'web-app.dashboard.show-user-profile')
                <div class="listing-avatar">
                    ...
                    @endif
                    <span class="avatar-tooltip">Added By <strong>{{ $opportunity->opportunity_user->first_name.' '.$opportunity->opportunity_user->last_name }}</strong></span>
                </div>
            @endif
        ...
        <div class="geodir-category-content fl-wrap title-sin_item" style="margin-top: 10px !important;">
            ...
            <div class="geodir-category-text fl-wrap">
                ...
                <div class="facilities-list fl-wrap">
                    <div class="facilities-list-title">Funding Details: {{ $profile_image }}</div>
