...
@php
    ...
    if (!$opportunity->opportunity_seeking->isEmpty()) {
        ...
        foreach ($opportunity->opportunity_seeking as $seeking) {
            ...
            $opportunity_gap[] = '<span class="finance-details">'.$seeking['seeking_name'].'</span>';
        }
        ...
        $opportunity_seek = '<span class="finance-details">Seeking details unavailable</span>';
                ...
                <div class="facilities-list fl-wrap">
                    ...
                    <ul class="no-list-style" style="text-align: right !important; padding-right: 10px !important;">
                        @php
                            ...
                            $opportunity_gap = [
                                                '<span class="finance-details">Investors</span>',
                                                '<span class="tolt finance-details">Donors</span>',
                                                '<span class="tolt finance-details">Incubation</span>'
                                            ];
                        ...
                        {!! $opportunity->opportunity_seeking !!}
                    </ul>
                </div>
            </div>
