        ...
        <div class="geodir-category-content fl-wrap title-sin_item" style="margin-top: 10px !important;">
            ...
            <div class="geodir-category-text fl-wrap">
                ...
                <div class="facilities-list fl-wrap">
                    <div class="facilities-list-title">Looking For?:</div>
                    <ul class="no-list-style">
                        @php
                            $opportunity_gap = ['<span class="tolt finance-details">Investors</span>''<span class="tolt finance-details">Donors</span>', '<span class="tolt finance-details">Incubation</span>']
                            $opportunity_seek = implode('<span class="funding-separator">&nbsp;&nbsp;|&nbsp;&nbsp;</span>', );
