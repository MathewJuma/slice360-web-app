        ...
        <div class="geodir-category-content fl-wrap title-sin_item" style="margin-top: 10px !important;">
            ...
            <div class="geodir-category-text fl-wrap">
                ...
                <div class="facilities-list fl-wrap">
                    <div class="facilities-list-title">Opportunity Gap:</div>
                    <ul class="no-list-style">
                        <span class="tolt finance-details" data-microtip-position="top" data-tooltip="Opportunity looking for?"> ${{ number_format($opportunity['amount_needed'],0,',') }}
                        </span>
