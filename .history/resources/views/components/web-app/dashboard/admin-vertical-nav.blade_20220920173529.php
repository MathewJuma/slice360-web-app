    ...
    <div class="user-profile-menu-wrap fl-wrap block_box">
        ...
        <div class="user-profile-menu">
            ...
            <ul  class="no-list-style">
                ...
                <li><a href="dashboard-bookings.html"> <i class="fal fa-calendar-check"></i> Published Opportunities <span>2</span></a></li>
                <li><a href="dashboard-bookings.html"> <i class="fal fa-lock"></i> Reviews Opportunities <span>2</span></a></li>
            </ul>
        </div>
        <!-- user-profile-menu end-->
