...
@php
    ...
    if(){
        $sub_menu_styling = 'style="display: block !important;"';
    }else{
        $sub_menu_styling = '';
    }

    dd(in_array($current_route_name, $sub_menu_items) ? 'style="display: block !important;"' : '');
            ...
            <ul  class="no-list-style">
                ...
                <li>
                    ...
                    <ul class="no-list-style sub-menu-padding" {{ $sub_menu_styling }} >
                        <li><a href="#" class="{{ $current_route_name == 'web-app.opportunities.edit-opportunity' ? 'user-profile-act' : '' }}"><i class="fal fa-edit"></i> Edit Opportunities</a></li>
