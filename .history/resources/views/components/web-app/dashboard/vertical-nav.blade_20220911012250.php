    ...
    <div class="user-profile-menu-wrap fl-wrap block_box">
        ...
        <div class="user-profile-menu">
            ...
            <ul class="no-list-style">
                ...
                <li><a href="{{ route('web-app.dashboard.main-dashboard', $user_id) }}" class="{{ $current_route_name == 'web-app.dashboard.main-dashboard' ? 'user-profile-act' : '' }}"><i class="fal fa-user"></i>My Profile</a></li>
