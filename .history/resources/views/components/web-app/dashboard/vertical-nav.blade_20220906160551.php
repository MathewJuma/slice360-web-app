    ...
    <div class="user-profile-menu-wrap fl-wrap block_box">
        ...
        <div class="user-profile-menu">
            ...
            <ul class="no-list-style">
                ...
                <li><a href="{{ route('web-app.dashboard.edit-user-profile', session()->get('system_user_id')).'-'.Str::slug($opportunity_details->title)) }}" class="{{ $current_route_name == 'web-app.dashboard.edit-user-profile' ? 'user-profile-act' : '' }}"> <i class="fal fa-user-edit"></i> Edit profile</a></li>
