    ...
    <div class="user-profile-menu-wrap fl-wrap block_box">
        ...
        <div class="user-profile-menu">
            ...
            <ul class="no-list-style">
                ...
                <li><a href="{{ route('web-app.opportunities.edit-user-profile', '10') }}" class="{{ $current_route_name == 'web-app.opportunities.edit-user-profile' ? 'user-profile-act' : '' }}><i class="fal fa-user-edit"></i> Edit profile</a></li>
