        ...
        <div class="user-profile-menu">
            ...
            <ul  class="no-list-style">
                ...
                <li>
                    <a href="#" class="submenu-link"><i class="fal fa-plus"></i>More Settings</a>
                    <ul  class="no-list-style sub-menu-padding">
                        <li><a href="#"><i class="fal fa-key"></i> Edit Opportunity</a></li>
                        <li><a href="#"> <i class="fal fa-user"></i> Create Timeline</a></li>
                        <li><a href="#"><i class="fal fa-image"></i>Opportunity Banner</a></li>
                        <li><a href="#"><i class="fal fa-image"></i>Opportunity Images</a></li>
                    </ul>
                </li>
                <li><a href="dashboard-bookings.html"> <i class="fal fa-calendar-check"></i> Opportunity <span>2</span></a></li>
                <li><a href="dashboard-bookings.html"> <i class="fal fa-calendar-check"></i> Edit Opportunity <span>2</span></a></li>
