    ...
    <section class="gray-bg main-dashboard-sec" id="sec1" style="margin-bottom: -50px !important;">
        ...
        <div class="container">
            ...
            <div class="col-md-3">
                ...
                {{-- if is_admin - load admin menu --}}
                @if ($user_details->is_admin === 1)

                    <!-- component :: general vertical nav -->
                    <x-web-app.dashboard.admin-vertical-nav :user_details='$user_details'/>
                    <!--  component :: general vertical nav  end -->

                @else

                    <!-- component :: general vertical nav -->
                    <x-web-app.dashboard.general-vertical-nav :user_details='$user_details' />
                    <!--  component :: general vertical nav  end -->

                @endif
                {{-- if is_admin - load admin menu end --}}
