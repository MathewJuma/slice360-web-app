            ...
            <ul  class="no-list-style">
                ...
                <li>
                    ...
                    <ul  class="no-list-style sub-menu-padding">
                        <li><a href="{{ route('web-app.opportunities.edit-opportunity') }}" class="{{ $current_route_name == 'web-app.opportunities.edit-opportunity' ? 'user-profile-act' : '' }}"><i class="fal fa-edit"></i> Edit Opportunities</a></li>
