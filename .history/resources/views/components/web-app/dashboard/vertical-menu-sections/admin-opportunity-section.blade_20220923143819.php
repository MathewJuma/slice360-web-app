...
<div class="user-profile-menu">
    ...
    <ul  class="no-list-style">
        <li><a href="{{ route('admin-app.opportunities.admin-fetch-opportunities') }}" id="admin-fetch-opportunities" class="{{ $current_route_name == 'admin-app.opportunities.admin-fetch-opportunities' ? 'user-profile-act' : '' }}"><i class="fal fa-th-list"></i> All Opportunities </a></li>
        <li>
