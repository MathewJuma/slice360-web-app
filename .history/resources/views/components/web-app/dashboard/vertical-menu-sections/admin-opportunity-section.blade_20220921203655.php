...
<div class="user-profile-menu">
    ...
    <ul  class="no-list-style">
        <li><a href="{{ route('web-app.opportunities.admin-opportunities-page') }}" id="admin-opportunities-page" class="{{ $current_route_name == 'web-app.opportunities.admin-opportunities-page' ? 'user-profile-act' : '' }}"><i class="fal fa-th-list"></i> All Opportunities </a></li>
        <li>
