<div class="col-md-3">
    ...
    <div class="fixed-bar fl-wrap" id="dash_menu">
        <div class="user-profile-menu-wrap fl-wrap block_box" style=" border:1px solid red;">
            <!-- user-profile-menu-->
            <div class="user-profile-menu" style=" border:1px solid blue;margin-left: -15px !important;">
                <h3>Main</h3>
