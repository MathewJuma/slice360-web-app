...
@php
    ...
    dd(last(explode('.', $current_route_name)));
    //current page
    //$current_page_name = Str::title(str_replace("-", " ")));

    //dd($current_page_name);
...
<section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
    <div class="container">
        <div class="dashboard-breadcrumbs breadcrumbs">
            ...
            <span style="color: #4db7fe !important; font-weight: 700 !important;">{{ $current_page_name }}</span>
        </div>
