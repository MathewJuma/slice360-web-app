...
@php
    ...
    if(in_array($current_route_name, $sub_menu_items)){
        $sub_menu_styling = 'style = "display: block;';
    }else{
        $sub_menu_styling = '';
    }

    dd($sub_menu_styling); exit();
        ...
        <div class="user-profile-menu">
            ...
            <ul  class="no-list-style">
                ...
                <li>
                    ...
                    <ul  class="no-list-style sub-menu-padding" @php in_array($current_route_name, $sub_menu_items) ? 'style="display: block;"' : '' @endphp >
                        <li><a href="{{ route('web-app.opportunities.edit-opportunity', $current_opportunity_id) }}" class="{{ $current_route_name == 'web-app.opportunities.edit-opportunity' ? 'user-profile-act' : '' }}"><i class="fal fa-edit"></i> Edit Opportunities</a></li>
