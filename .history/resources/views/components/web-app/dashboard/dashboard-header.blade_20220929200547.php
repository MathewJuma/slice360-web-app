...
@php
    ...
    //current page
    $current_page_name = Str::title(str_replace("-", " ", explode('.', $current_route_name)[2]));
...
<section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
    <div class="container">
        <div class="dashboard-breadcrumbs breadcrumbs">
            ...
            <span style="color: #ffffff !important; font-weight: 700 !important;">{{ $current_page_name }}</span>
        </div>
