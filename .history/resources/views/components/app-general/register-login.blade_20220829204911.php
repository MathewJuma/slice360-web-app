                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.exists){
                                    ...
                                    $('#jquery_nofications').html('<div class="add-list color-bg" id="jquery_nofications">This email already exists</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else if(response.success){
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').html('<div class="add-list color-bg" id="jquery_nofications">User account created successfully</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else{
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').html('<div class="add-list color-bg" id="jquery_nofications">An error occurred. Please try again later.</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }
