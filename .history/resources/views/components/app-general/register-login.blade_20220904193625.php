                ...
                $(user_login_form).validate({
                    ...
                    messages: {
                        login_email: {
                            ...
                            email: "Your email address must be of a valid email format"
                        },
                        login_password: "Please fill-in a valid password"
                    },
                                ...
                                if($.isEmptyObject(response.error)){
                                    ...
                                    if(response.success){
                                        ...
                                        $('.jquery_nofications').html(
                                            '<div class="add-list color-bg" id="jquery_nofications_wrapper">You successfully logged-in</div>'
                                            );
                                    ...
                                    $('.jquery_nofications').fadeIn();
                                    $('.jquery_nofications').html(
                                        '<div class="add-list color-bg" id="jquery_nofications_wrapper" style="color: red !important;">An error occurred. Check your login details or please try again later.</div>'
                                        );
                                    setTimeout(function() {
                                        $('.jquery_nofications').fadeOut();
                                    }, 5000);
