...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('web_app/css/font_awesome/v4-font-face.css') }}">
        <link type="text/css" rel="stylesheet" href="{{ asset('web_app/css/font_awesome/v5-font-face.css') }}">
