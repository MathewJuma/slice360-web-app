    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#user_register_submit').click(function() {
                ...
                var user_register_form = $('#user_register_submit').parents('form'); //alert(form); die();
                ...
                $(user_register_form).validate({
                    ...
                    submitHandler: function() {
                        ...
                        var form_data = new FormData(user_register_form[0]);
                        ...
                        $.ajax({
                            ...
                            error:function (response) {
                                ...
                                $('#privacy_error').text(response.responseJSON.errors.privacy);
                                $('#terms_error').text(response.responseJSON.errors.terms);
                            }
                        });
