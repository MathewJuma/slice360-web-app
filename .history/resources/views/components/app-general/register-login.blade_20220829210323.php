                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.exists){
                                    ...
                                    $('#jquery_nofications').html('<div class="add-list color-bg jquery_nofication_content">User account created successfully</div>');
                                    $('#jquery_nofication_content').toggleClass("jquery_nofications_wrapper");
                                    $('#jquery_nofication_content').fadeIn();
                                    setTimeout(function(){
                                        $('#jquery_nofication_content').fadeOut();
                                    ...
                                    $('#jquery_nofications').html('<div class="add-list color-bg jquery_nofication_content">An error occurred. Please try again later.</div>');
                                    $('#jquery_nofication_content').toggleClass("jquery_nofications_wrapper");
                                    $('#jquery_nofication_content').fadeIn();
                                    setTimeout(function(){
                                        $('#jquery_nofication_content').fadeOut();
