                        ...
                        <div id="tab-2" class="tab-content">
                            <div class="custom-form">
                                <form method="post" action="/register-users" name="registerform" class="main-register-form" id="main-register-form2">
                                    ...
                                    <input name="full_name" type="text" onClick="this.select()" value="{{ old('full_name') }}">
                                    <label >Username <span>*</span> </label>
                                    <input name="username" type="text" onClick="this.select()" value="{{ old('username') }}">
                                    <label>Email Address <span>*</span></label>
                                    <input name="email" type="text"  onClick="this.select()" value="{{ old('email') }}">
                                    <label >Password <span>*</span></label>
                                    <input name="password" type="password"   onClick="this.select()" value="{{ old('password') }}" >
                                    <label >Confirm Password <span>*</span></label>
                                    <input name="password_confirmation" type="password"   onClick="this.select()" value="{{ old('password_confirmation') }}" >
                                    ...
                                    <div class="clearfix"></div>
                                    <button type="submit" class="btn float-btn color2-bg" id="registerUser" > Register  <i class="fas fa-caret-right"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
