                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if(data.exists){
                                    ...
                                    $('#jquery_nofications').html('<p>This email already exists</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else if(data.success){
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').html('<p>User account created successfully</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else{
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').html('<p>An error occurred. Please try again later.</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }
