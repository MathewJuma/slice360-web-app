    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#user_login_submit').click(function(e) {
                ...
                //2. this is the user login form
                var user_login_form = $('#user_login_submit').parents('form');

                //3. get all login form values
                var _token = $("input[name='_token']").val();
                var login_email = $('#login_email').val();
                var login_password = $('#login_password').val();

                //4. validate the "user_register_form" form using jquery validator
                $(user_login_form).validate({
                    ...
                    //4.2 validationn response messages
                    messages: {
                        login_email: "Please fill-in your email address",
                        login_password: "Please fill-in a valid password"
                    },

                    //4.3 validation error highlight
                    highlight: function(element) {
                        $(element).addClass('error_colors');
                    },

                    //4.4 submission incase validation is passed
