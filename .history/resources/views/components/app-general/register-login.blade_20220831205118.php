                        ...
                        <div id="tab-2" class="tab-content">
                            <div class="custom-form user-registration-form">
                                <form action="javascript:void(0);" method="post" name="user_register_form" class="main-register-form" id="user_register_form">
                                    ...
                                    <label id="full_name_error" class="error" for="full_name"></label>

                                    <label>Username <span>*</span> </label>
                                    <input type="text" name="username" id="username">
                                    <label id="username_error" class="error" for="username"></label>
                                    ...
                                    <label id="password_confirmation_error" class="error" for="password_confirmation"></label>

                                    <div class="filter-tags ft-list">
                                        <input type="checkbox" name="privacy" id="privacy">
                                        <label id="privacy_error" class="error" for="privacy"></label>
                                        <label for="privacy">
                                    ...
                                    <div class="filter-tags ft-list">
                                        ...
                                        <label id="terms_error" class="error" for="terms">test</label>
                                        <label for="terms">
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            error:function (response) {
                                $('#full_name_error').text(response.responseJSON.errors.name);
                                $('#username_error').text(response.responseJSON.errors.email);
                                $('#email_error').text(response.responseJSON.errors.subject);
                                $('#password_error').text(response.responseJSON.errors.mobile_number);
                                $('#password_confirmation_error').text(response.responseJSON.errors.message);
                                $('#privacy_error').text(response.responseJSON.errors.message);
                                $('#terms_error').text(response.responseJSON.errors.message);
                            }
                        });
