                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                console.log(response); die(0);
                                if(response.exists){
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').text('<div class="add-list color-bg">This email already exists</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else if(response.success){
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').text('<div class="add-list color-bg">User account created successfully</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else{
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').text('<div class="add-list color-bg">An error occurred. Please try again later.</div>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }
