    ...
    <body>
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <div class="lang-wrap" style="width: 200px !important;">
                    <div class="show-lang"  style="width: 200px !important;">
                        <span>
                            <i class="fal fa-cog"></i><strong> Manage Opportunities</strong>
                        </span>
                        <i class="fa fa-caret-down arrlan"></i>
                    </div>
                    <ul class="lang-tooltip lang-action no-list-style">
                        <li><a href="#" data-lantext="Logout">Logout</a></li>
                    </ul>
                </div>
