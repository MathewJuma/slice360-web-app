        ...
        $(document).ready(function() {
            ...
            $('#user_login_submit').click(function() {
                ...
                $(user_login_form).validate({
                    ...
                    messages: {
                        login_email: {
                            required: "Your valid email address is required",
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.exists) { //case error exists
                                    ...
                                    $('.jquery_nofications').fadeIn();
                                    $('.jquery_nofications').html(
                                        '<div class="add-list color-bg" id="jquery_nofications_wrapper" style="color: #dc3545 !important; !important;">This user email already exists</div>'
                                        );
                                    setTimeout(function() {
                                        $('.jquery_nofications').fadeOut();
                                    }, 5000);
