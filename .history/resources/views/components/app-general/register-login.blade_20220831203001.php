                        ...
                        <div id="tab-2" class="tab-content">
                            <div class="custom-form user-registration-form">
                                <form action="javascript:void(0);" method="post" name="user_register_form" class="main-register-form" id="user_register_form">
                                    ...
                                    <label id="username_error" class="error" for="full_name"></label>

                                    <label>Email Address <span>*</span></label>
                                    <input type="email" name="email" id="email">
                                    <label id="email_error" class="error" for="full_name"></label>

                                    <label>Password <span>*</span></label>
                                    <input type="password" name="password" id="password">
                                    <label id="password_error" class="error" for="full_name"></label>
