                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.exists){
                                    ...
                                    $('.jquery_nofications').html('<div class="add-list color-bg" id="jquery_nofications_wrapper">This email already exists</div>');
                                    setTimeout(function(){
                                        $('.jquery_nofications').fadeOut();
                                    }, 3000);
                                }else if(response.success){
                                    $('.jquery_nofications').fadeIn();
                                    $('.jquery_nofications').html('<div class="add-list color-bg" id="jquery_nofications_wrapper">User account successfully created</div>');
                                    setTimeout(function(){
                                        $('.jquery_nofications').fadeOut();
                                    }, 3000);
                                }else{
