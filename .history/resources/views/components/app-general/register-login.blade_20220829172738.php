                ...
                <div class="tab">
                    ...
                    <div class="tab">
                        <div id="tab-2" class="tab-content">
                            <div class="custom-form">
                                <form method="post" action="/register_users" name="registerform" class="main-register-form" id="main-register-form2">
                                    @csrf
                                    <label >Full Name <span>*</span> </label>
                                    <input name="full_name" type="text" onClick="this.select()" value="{{ old('name') }}">
                                    ...
                                    <input name="passwordConfirm" type="password"   onClick="this.select()" value="" >
