<div class="main-register-wrap modal login_registration_modal">
                ...
                <div class="tab">
                    ...
                    <div id="tab-1" class="tab-content first-tab">
                        <div class="custom-form">
                            <form action="javascript:void(0);" method="post" name="user_login_form">
                                <label>Username or Email Address <span>*</span> </label>
                                <input name="login_email" type="text" id="login_email">
                                <label>Password <span>*</span> </label>
                                <input name="login_password" type="password" id="login_password">
                                <button type="submit" class="btn float-btn color2-bg" id="login_submit">
                    ...
                    <div class="tab">
                        <div id="tab-2" class="tab-content">
                            <div class="custom-form user-registration-form">
                                <form action="javascript:void(0);" method="post" name="user_register_form">
