                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if(data.exists){
                                    ...
                                    $('#jquery_nofications').text('<p>This email already exists</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else if(data.success){
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').text('<p>User account created successfully</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }else{
                                    $('#jquery_nofications').fadeIn();
                                    $('#jquery_nofications').text('<p>An error occurred. Please try again later.</p>');
                                    setTimeout(function(){
                                        $('#jquery_nofications').fadeOut();
                                    }, 3000);
                                }
