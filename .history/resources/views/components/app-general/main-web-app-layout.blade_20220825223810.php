    ...
    <body>
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <div class="show-reg-form modal-open avatar-img" data-srcav="{{ asset('web_app/images/avatar/3.jpg') }}">
                ...
                <div class="lang-wrap">
                    <div class="show-lang">
                        <span>
                            <i class="fal fa-globe-europe"></i><strong>En</strong>
                        </span>
                ...
                <!--  top-bar navigation -->
                {{-- @include('partials.web-app-partials._top_bar') --}}
                <!-- top-bar navigation  end -->

                <!-- header-search_container -->
                {{-- @include('partials.web-app-partials._search_top', ['countries'=>$countries, 'categories'=>$categories]) --}}
                <!-- header-search_container  end -->

                <!-- wishlist-wrap-->
                {{-- @include('partials.web-app-partials._wish_list') --}}
                <!--wishlist-wrap end -->
            </header>
            {{-- end :: header section --}}
            ...
            <footer class="main-footer fl-wrap">
                ...
                <div class="sub-footer  fl-wrap">
                    <div class="container">
                        <div class="copyright"> {{ year() }} &#169;Slice360 .  All rights reserved.</div>
                        <div class="lang-wrap">
        ...
        {{-- <x-web-app-components.flash-message /> --}}
