@php
    ...
    foreach($post->comments as $comment){
        $published_comments = $published_comments + $comment->published;
    }
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="list-single-main-item fl-wrap block_box">
                                    ...
                                    @if ($post->comments->count() > 0 && $published_comments > 0)
                            ...
                            <div class="col-md-4">
                                <div class="box-widget-wrap fl-wrap fixed-bar">
                                    ...
                                    <!-- blog-tags_container -->
                                    @include('partials.web-app.opportunities._news_subscription', ['popular_categories'=>$popular_categories])
                                    <!-- blog-tags_container  end -->
                                </div>
                            </div>
                        </div>
