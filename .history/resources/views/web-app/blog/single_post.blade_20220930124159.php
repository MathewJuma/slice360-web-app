                        ...
                        submitHandler: function() {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    var success_response = $.parseJSON(response);

                                    //console.log(success_response.success)
                                },
                                error: function(response){

                                    //var len = response.length;
                                    var error_response = $.parseJSON(response);

                                    //console.log(len);

                                    $('.jquery_nofications').fadeIn();
                                        $('.jquery_nofications').html(
                                            '<div class="add-list color-bg" id="jquery_nofications_wrapper" style="color: #dc3545 !important; !important;">' + error_response.errors + '</div>'
                                            );
                                        setTimeout(function() {
