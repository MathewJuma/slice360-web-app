                                    ...
                                    <div class="list-single-main-item_content fl-wrap" style="text-align: left !important;">
                                        <div class="reviews-comments-wrap" style="width: 100% !important;">
                                            @if ($post->comments->count() > 0)
                                                ...
                                                <div class="description-holder scrollbar-inner2 text-left"  data-simplebar="init" data-simplebar-auto-hide="true" style="border: 1px solid red; min-height: 50px !important;">
                                                    <!--begin :: post comments-->
