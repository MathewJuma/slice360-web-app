                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="list-single-main-item fl-wrap block_box">
                                    ...
                                    <div class="list-single-main-item_content fl-wrap" style="border: 1px solid black; text-align: left !important;">
                                        <div class="reviews-comments-wrap" style="border: 1px solid black;">
                                            @if ($post->comments->count() > 0)
                                                <div class="row" style="border: 1px solid black;">
                                                        <div class="col-md-12 mt-3 mb-4" style="border: 1px solid black;">
                                                            <!--begin :: post comments-->
