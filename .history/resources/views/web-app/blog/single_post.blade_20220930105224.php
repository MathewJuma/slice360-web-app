                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="list-single-main-item fl-wrap block_box">
                                    ...
                                    <div class="list-single-main-item_content fl-wrap" style="text-align: left !important;">
                                        <div class="reviews-comments-wrap fl-wrap" style="width: 100% !important;">
                                            @if ($post->comments->count() > 0)

                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="description-holder scrollbar-inner2 text-left"  data-simplebar="init" data-simplebar-auto-hide="true" style="border: 1px solid red; min-height: 50px !important; width: 100% !important;">
                                                    <!--begin :: post comments-->
