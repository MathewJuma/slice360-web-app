    ...
    <section class="no-top-padding-sec" id="sec1" style="background-color: #f6f6f6 !important;">
        <div class="container">
            <div class="breadcrumbs inline-breadcrumbs fl-wrap block-breadcrumbs">
                ...
                <span class="current-breadcrumbs">User Profile</span>
            </div>
            <div class="fl-wrap">
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="user-profile-header_media fl-wrap">
                                ...
                                <div class="user-profile-header_stats">
                                    <ul class="no-list-style">
                                        <li class="general-btn"><span>{{ $user_opportunities->total() }}</span>Opportunities</li>
                                        <li class="general-btn"><span>{{ count($followed_by_user_id) }}</span>Followers</li>
                                        <li class="general-btn"><span>{{ count($following_user_id) }}</span>Following</li>
                                    </ul>
                                </div>
                                    ...
                                    @if (in_array(auth()->id(), $followed_by_user_id))
                                        ...
                                        <form action="javascript:void(0);" method="post" id="user_unfollow_form">
                                            ...
                                            <button type="submit" id="user_unfollow_submit">
                                                <div class="follow-btn color2-bg general-btn">Unfollow <i class="fal fa-user-minus"></i></div>
                                            </button>
                                        </form>
                                    ...
                                    @else
                                        ...
                                        <form action="javascript:void(0);" method="post" id="user_follow_form">
                                            ...
                                            <button type="submit" id="user_follow_submit">
                                                <div class="follow-btn color2-bg general-btn">Follow <i class="fal fa-user-plus"></i></div>
                                            </button>
                                        </form>
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="box-widget-item fl-wrap block_box">
                                ...
                                <div class="box-widget">
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="get_intouch_form">
                                            @csrf
                                            <fieldset>
                                                <input type="hidden" name="sender_id" id="sender_id" value="{{ auth()->id() }}">
                                                <input type="hidden" name="receiver_id" id="receiver_id" value="{{ $user_details->id}}">
                                                <input type="hidden" name="status" id="status" value="1">
                                                <label><i class="fal fa-user"></i></label>
                                                <input type="text" disabled placeholder="To: {{ $user_details->first_name . ' ' . $user_details->last_name }}" name="actual_receiver" id="actual_receiver" value="{{ $user_details->first_name . ' ' . $user_details->last_name }}" />
                                                <div class="clearfix"></div>
                                                <textarea cols="40" rows="3" placeholder="Write your get-intouch message:" name="intouch_message" id="intouch_message"></textarea>
                                            </fieldset>
                                            <button type="submit" class=" btn float-btn color2-bg general-btn" id="get_intouch_submit">
                        ...
                        @if ( Auth::check() && auth()->id() === $user_details->id)
                            <div class="box-widget-item fl-wrap block_box">
                                <div class="box-widget-item-header">
                                    <h3>Give a Testimonial</h3>
                                </div>
                                <div class="box-widget">
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="give_testimonial_form">
                                            @csrf
                                            <fieldset>
                                                <input type="hidden" name="user_id" id="user_id" value="{{ auth()->id() }}">
                                                <input type="hidden" name="status" id="status" value="1">
                                                <label><i class="fal fa-user"></i></label>
                                                <input type="text" placeholder="Business Role *"name="business_role" id="business_role" value="" />
                                                <div class="clearfix" style="margin-bottom: 15px !important;"></div>
                                                <label><i class="fal fa-globe"></i> </label>
                                                <input type="text" placeholder="Your Location* (City, Country)" name="your_location" id="your_location" value="" />
                                                <div class="clearfix" style="margin-bottom: 15px !important;"></div>
                                                <textarea cols="40" rows="3" placeholder="Write your testimonial:*" name="testimonial_message" id="testimonial_message"></textarea>
                                                <!-- platform rating-->
                                                <div class="review-range-item" style="">
                                                    <div class="range-slider-title" style="width: 100% !important; margin-top: 30px !important; margin-bottom: 10px !important;">Platform Rating</div>
                                                    <div class="clearfix" style="margin-bottom: 15px !important;"></div>
                                                    <div class="range-slider-wrap" style="width: 100% !important;">
                                                        <input type="text" class="rate-range" data-min="0" data-max="5" name="platform_rating"  data-step="1" value="0" id="platform_rating">
                                                    </div>
                                                </div>
                                                <!-- platform rating end-->
                                            </fieldset>
                                            <button type="submit" class=" btn float-btn color2-bg general-btn" id="give_testimonial_submit">
                                                Post Testimonial<i class="fal fa-paper-plane"></i>
                                            </button>
                                        </form>
                                    </div>
                                </div>
    ...
    @push('custom_javascript')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //process when the "give_testimonial_submit" button is clicked
                $('#give_testimonial_submit').click(function() {

                    //1. this is the user give testimonial form
                    var give_testimonial_form = $('#give_testimonial_submit').parents('form');

                    //2. these are all the form parameters
                    var _token = $("input[name='_token']").val();
                    var user_id = $('#user_id').val();
                    var platform_rating = $('#platform_rating').val();
                    var business_role = $('#business_role').val();
                    var your_location = $('#your_location').val();
                    var testimonial_message = $('#testimonial_message').val();
                    var status = $('#status').val();

                    //3. validate the "user_register_form" form using jquery validator
                    $(give_testimonial_form).validate({
                        ...
                        messages: {
                            business_role: {
                                required: "Please fill-in your business role",
                                minlength: "Business role must be at-least 5 characters",
                                maxlength: "Business role must be at-most 50 characters",
                            },
                            your_location: {
                                required: "Please fill-in your location",
                                minlength: "Location details must be at-least 5 characters",
                                maxlength: "Location details must be at-most 60 characters",
                            },
                            testimonial_message: {
                                required: "Please fill-in your testimonial message",
                                minlength: "Testimonial message must be at-least 25 characters",
                                maxlength: "Testimonial message must be at-most 500 characters",
                            },
                        },
                        ...
                        submitHandler: function() {
                            ...
                            //create a new instance of the form with all form data having passed validation
                            form_data = new FormData(give_testimonial_form[0]);

                            //start process ajax code
                            $.ajax({
                                type: "POST",
                                url: "{{ route('app-general.users.submit-testimonial') }}",
                                data: form_data,
                                dataType: "JSON",
                                processData: false,
                                contentType: false,
                                success: function(response) {
                                    //console.log(response['success_updating']); die();
                                    if (response.success_updating) { //case error exists

                                        //clear all the data
                                        $('#give_testimonial_form').each(function() {
                                            this.reset();
                                        });

                                        $('.jquery_nofications').fadeIn();
                                        $('.jquery_nofications').html(
                                            '<div class="add-list color-bg" id="jquery_nofications_wrapper">Your testimonial has been updated successfully</div>'
                                        );
                                    ...
                                    } else if (response.success_creating) { //case submission success
                                        ...
                                        $('.jquery_nofications').fadeIn();
                                        $('.jquery_nofications').html(
                                            '<div class="add-list color-bg" id="jquery_nofications_wrapper">Your testimonial has been created successfully</div>'
                                        );
                ...
                //process when the "get_intouch_form" button is clicked
                $('#get_intouch_submit').click(function() {

                    //1. this is the user get intouch form
                    var get_intouch_form = $('#get_intouch_submit').parents('form');

                    //2. these are all the form parameters
                    var _token = $("input[name='_token']").val();
                    var sender_id = $('#sender_id').val();
                    var receiver_id = $('#receiver_id').val();
                    var actual_receiver = $('#actual_receiver').val();
                    var intouch_message = $('#intouch_message').val();
                    var status = $('#status').val();

                    //3. validate the "get_intouch_form" form using jquery validator
                    $(get_intouch_form).validate({
                        ...
                        messages: {
                            intouch_message: {
                                ...
                                maxlength: "Message must be at-most 500 characters",
                            },
                        },
                        ...
                        submitHandler: function() {
                            ...
                            //create a new instance of the form with all form data having passed validation
                            form_data = new FormData(get_intouch_form[0]);

                            //start process ajax code
                            $.ajax({
                                type: "POST",
                                url: "{{ route('app-general.users.get-intouch-message') }}",
                                data: form_data,
                                dataType: "JSON",
                                processData: false,
                                contentType: false,
                                success: function(response) {
                                    //console.log(response['success_updating']); die();
                                     if (response.success) { //case submission success

                                        //clear all the data
                                        $('#get_intouch_form').each(function() {
                                            this.reset();
                                        });

                                        $('.jquery_nofications').fadeIn();
                                        $('.jquery_nofications').html(
                                            '<div class="add-list color-bg" id="jquery_nofications_wrapper">Your message has successfully been sent to ' + actual_receiver + '</div>'
                                        );
