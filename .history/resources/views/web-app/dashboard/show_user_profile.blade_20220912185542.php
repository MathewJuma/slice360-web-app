                                ...
                                <div class="box-widget">
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="get_intouch_form">
                                            @csrf
                                            <fieldset>
                                                <input type="hidden" name="sender_id" id="user_id" value="{{ auth()->id() }}">
                                                <input type="hidden" name="receiver_id" id="opportunity_id" value="{{ $opportunity_details->id }}">
                                                <input type="hidden" name="status" id="status" value="0">
                                                <label><i class="fal fa-user"></i></label>
                                                <input type="text" disabled placeholder="To: {{ $user_details->first_name . ' ' . $user_details->last_name }}" value="" />
                                                <div class="clearfix"></div>
                                                <textarea cols="40" rows="3" placeholder="Message Information:" id="intouch_message"></textarea>
                                            </fieldset>
