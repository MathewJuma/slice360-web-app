                                        ...
                                        <div class="col-md-12 mt-3 mb-4">
                                            ...
                                            @if (Auth::check() && auth()->id() === $user_details->id)
                                                <p style="text-align:center !important; font-size: 14px !important; color: #4db7fe !important;">
                                                    You have not yet updated your profile description. Updating your profile makes it easy for potential investors to relate with you.
                                                </p>
                                            @else
                                                <p style="text-align:center !important; font-size: 14px !important; color: #325096 !important;">
