                                    ...
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="get_intouch_form">
                                            ...
                                            <fieldset>
                                                ...
                                                <textarea cols="40" rows="3" placeholder="Message Information:"></textarea>
                                            </fieldset>
                                            <button type="submit" class=" btn float-btn color2-bg custom_submit_buttons_inner" id="opportunity_unfollow_submit">
