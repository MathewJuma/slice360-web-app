                                    ...
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="give_testimonial_form">
                                            ...
                                            <fieldset>
                                                ...
                                                <label><i class="fal fa-user"></i></label>
                                                <input type="text" placeholder="Business Role *" name="business_role" value="" />
                                                <div class="clearfix"></div>
                                                <label><i class="fal fa-globe"></i> </label>
                                                <input type="text" placeholder="opportunity Location*" name="opportunity_location" value="" />
                                                <textarea cols="40" rows="3" placeholder="Write your testimonial:*" name="testimonial_message"></textarea>
                                            </fieldset>
