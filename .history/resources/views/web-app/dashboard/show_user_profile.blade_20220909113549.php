                                        ...
                                        <div class="col-md-12 mt-3 mb-4">
                                            ...
                                            @if (Auth::check() && auth()->id() === $user_details->id)
                                                <p style="text-align:center !important; font-size: 14px !important; color: #4db7fe !important;">
                                                    Your profile description is not updated. Updating your profile makes it easy for potential investors to relate with you.
                                                </p>
                                            @else
                                                <p style="text-align:center !important; font-size: 14px; color: #325096 !important;">
                                                    <i class="fa fa-exclamation-circle" style="font-size: 24px !important;" aria-hidden="true"></i>
                                    ...
                                    @if (!Auth::check())
                                        <div class="row">
                                            <div class="col-md-12 mt-3 mb-5">
                                                <p style="text-align:center !important; font-size: 14px !important; color: #4db7fe !important;">
                                                    <i class="fa fa-exclamation-circle"></i>&nbsp;&nbsp;You must be logged in to see investor contacts
                                                </p>
                                            </div>
                                        </div>
                                    @else
