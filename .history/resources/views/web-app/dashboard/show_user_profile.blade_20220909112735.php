                            ...
                            <div class="user-profile-header_content fl-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @else
                                            <p style="text-align:center !important; font-size: 14px !important; color: #325096 !important;">User profile description has not yet been updated. Check later for profile updates.</p><br>
                                        @endif
                                    </div>
                                </div>
                                @else
