                ...
                <div class="custom-form">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="Second email address -- optional"  name="second_email" value=" {{ old('second_email') ?? @if ($user_profile->second_email) $user_profile->second_email  @endif }}" />
                            @error('second_email')
                                <p class="form_errors text-danger" style="font-size: 11px !important;">{{ $message }}</p>
                            @enderror
                        </div>
