                            ...
                            <div class="user-profile-header_media fl-wrap">
                                ...
                                <div class="user-profile-header_stats">
                                    <ul class="no-list-style">
                                        <li class="general-btn" style="cursor: pointer;"><span>{{ $user_opportunities->total() }}</span>Opportunities</li>
                                        <li class="general-btn" style="cursor: pointer;"><span>{{ count($followed_by_user_id) }}</span>Followers</li>
                                        <li class="general-btn" style="cursor: pointer;"><span>{{ count($following_user_id) }}</span>Following</li>
                                    </ul>
                                </div>
