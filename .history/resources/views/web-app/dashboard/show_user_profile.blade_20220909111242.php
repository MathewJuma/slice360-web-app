...
$brief_description = $user_profile->brief_description ?? '<p style="text-align:center !important; font-size: 14px !important; color: #325096 !important; padding-top: 10px !important; padding-bottom: 10px !important;">User profile description has not yet been updated. Check later for profile updates.</p><br>';
                            ...
                            <div class="box-widget">
                                <div class="box-widget-content bwc-nopad">
                                    ...
                                    @if (!Auth::check())
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class='text-danger' style="text-align:center !important; font-size: 14px !important; color: #325096 !important; padding-top: 10px !important; padding-bottom: 10px !important;">
                                                    <i class="fa fa-exclamation"></i>&nbsp;&nbsp;You must be logged in to see investor contacts
                                                </p>
                                            </div>
                                        </div>
                                    @else
