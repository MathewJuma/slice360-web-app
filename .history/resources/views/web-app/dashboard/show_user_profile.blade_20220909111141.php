                            ...
                            <div class="box-widget">
                                <div class="box-widget-content bwc-nopad">
                                    ...
                                    @if (!Auth::check())
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p style="text-align:center !important; font-size: 14px !important; color: #325096 !important; padding-top: 10px !important; padding-bottom: 10px !important;">
                                                    <i class="fal fa-map-marker"></i> You must be logged in to see investor contacts
                                                </p>
                                            </div>
                                        </div>
                                    @else
