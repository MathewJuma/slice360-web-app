            ...
            <div class="profile-edit-container fl-wrap block_box">
                <div class="custom-form">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea cols="40" rows="3" name='brief_description' id="brief_description" placeholder="Brief opportunity description"  name="" />{{ old('brief_description') ?? $user_profile->brief_description }}</textarea>
