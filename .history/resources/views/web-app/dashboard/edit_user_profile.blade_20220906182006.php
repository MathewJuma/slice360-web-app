                ...
                <div class="custom-form">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="JessieManrty@domain.com"  name="" value="{{ old('second_email') ?? $user_profile->second_email }}" />
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="+7(123)987654"  name="" value="{{ old('second_phone') ?? $user_profile->second_phone }}" />
                        </div>
                        <div class="col-sm-6">
                            <label> Address <i class="fas fa-map-marker"></i> </label>
                            <input type="text" placeholder="USA 27TH Brooklyn NY"  name="" value="{{ old('') ?? $user_profile->first_address  }}" />
                        </div>
                        <div class="col-sm-6">
                            <label> Second Address <i class="fas fa-map-marker"></i> </label>
                            <input type="text" placeholder="USA 27TH Brooklyn NY"  name="" value="{{ old('') ?? $user_profile->second_address  }}" />
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="general-input-item">
                            <textarea cols="40" rows="3" name='detailed_description' id="detailed_description" placeholder="Datails opportunity description"  name="" />{{ old('detailed_description') ?? $user_profile->brief_description }}</textarea>
                        </div>
