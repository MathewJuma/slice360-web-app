        ...
        <form action="{{ route('web-app.dashboard.update-user-profile', $user_details->id) }}" enctype="multipart/form-data" method="post" id="user_profile_form">
                ...
                <div class="custom-form">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @error('country_id')
                                <p class="form_errors-select text-danger" style="font-size: 11px !important;">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    <label>Breif Description <i class="fal fa-list"></i></label>
                    <textarea cols="40" rows="2" name='brief_description' id="brief_description" placeholder="Brief profile description"  name="" />{{ old('brief_description') ?? $brief_description }}</textarea>
                    @error('brief_description')
                        <p class="form_errors-tinymice text-danger" style="font-size: 11px !important;">{{ $message }}</p>
                    @enderror
            ...
            <div class="profile-edit-container fl-wrap block_box">
                ...
                <div class="row">
                    ...
                    <button class="btn color2-bg float-btn general-btn" id="edit_user_profile_submit">Save Changes<i class="fal fa-save"></i></button>
                </div>
            </div>
            <!-- profile-edit-container end-->
        ...
        @push('custom_javascript')
            ...
            <script type='text/javascript'>
                ...
                $(document).ready(function() {
                    ...
                    //only process if these two fields exists
                    if( $('#profile_image').length && $('#banner_image').length )
                    {
