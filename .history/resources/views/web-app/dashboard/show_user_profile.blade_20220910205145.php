...
foreach ($followed_by as $followed_by_details) {
    $followed_by_user_id[] = $followed_by_details->following_id;
}

//dd($following_user_id);
                            ...
                            <div class="user-profile-header_media fl-wrap">
                                ...
                                <div class="user-profile-header_stats">
                                    <ul class="no-list-style">
                                        ...
                                        <li><span>{{ $followed_by->count() }}</span>Followers</li>
                                        <li><span>{{ $following->count() }}</span>Following</li>
                                    </ul>
                                </div>
                                ...
                                @if (Auth::check() && auth()->id() != $user_details->id)
                                    ...
                                    @if (in_array(auth()->id(), $following_user_id))
