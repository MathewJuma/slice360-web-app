        ...
        <form action="{{ route('web-app.dashboard.update-user-profile', $user_details->id) }}" enctype="multipart/form-data" method="post">
            ...
            <div class="profile-edit-container fl-wrap block_box">
                <div class="custom-form">
                    ...
                    {{-- show only if images are absent --}}
                    @if (!isEmpty($user_profile_images->user_profile_banner) && !isEmpty($user_profile_images->user_profile_image))
                    ...
                    @endif
                    {{-- show only if images are absent end --}}
