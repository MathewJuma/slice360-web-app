    ...
    <div class="dashboard-title   fl-wrap">
                ...
                <div class="custom-form">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="Second phone -- optional"  name="" value="{{ old('second_phone') ?? $user_profile->second_phone }}" />
                        </div>
                        <div class="col-sm-6">
        ...
        @push('custom_javascript')
            ...
            <script type='text/javascript'>
                ...
                //use jquery to validate form
                $(document).ready(function() {

                    //process when the "user_login_submit" button is clicked
                    $('#edit_user_profile_submit').click(function() {

                        //1. prevent default form functionality
                        //e.preventDefault();

                        //1. this is the user profile form
                        var user_profile_form = $('#edit_user_profile_submit').parents('form');

                        //3. validate the "user_profile_form" form using jquery validator
                        $(user_profile_form).validate({
                            ...
                            submitHandler: function(user_profile_form) {
                                alert('success');
                            }
                        });
