                ...
                <div class="custom-form">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            @error('first_name')
                                <p class="form_errors text-danger" style="font-size: 10px !important;">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-md-6">
                            ...
                            @error('country_id')
                                <p class="form_errors text-danger" style="font-size: 10px !important;" style="padding-top: 10px !important;">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                                ...
                                <div class="add-list-media-wrap">
                                    <div class="listsearch-input-item fl-wrap">
                                        <div class="fuzone">
                                            ...
                                            <input type="file" class="upload" name="profile_image"  value="{{ old('profile_image') }}">
                                        </div>
                                    </div>
                                    @error('profile_image')
                                        <p class="form_errors text-danger" style="font-size: 10px !important;">{{ $message }}</p>
                                ...
                                <div class="add-list-media-wrap">
                                    <div class="listsearch-input-item fl-wrap">
                                        <div class="fuzone">
                                            ...
                                            <input type="file" class="upload" name="banner_image" value="{{ old('banner_image') }}">
                                        </div>
                                    </div>
                                    @error('banner_image')
                                        <p class="form_errors text-danger" style="font-size: 10px !important;">{{ $message }}</p>
