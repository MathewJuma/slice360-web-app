                                    ...
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="get_intouch_form">
                                            ...
                                            <fieldset>
                                                ...
                                                <textarea cols="40" rows="3" placeholder="Message Information:" name="intouch_message" id="intouch_message"></textarea>
                                            </fieldset>
                                    ...
                                    <div class="box-widget-content">
                                        <form action="javascript:void(0);" class="add-comment custom-form" method="post" id="give_testimonial_form">
                                            ...
                                            <fieldset>
                                                ...
                                                <textarea cols="40" rows="3" placeholder="Testimonial Message:*"></textarea>
                                            </fieldset>
