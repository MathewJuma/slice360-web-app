                ...
                <div class="custom-form">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" placeholder="First name"  name="" value="{{ old('') ?? $user_details->xx }}" />
                        </div>
                        <div class="col-sm-4">
                            <label>Middle Name <i class="fal fa-user"></i></label>
                            <input type="text" placeholder="Middle name"  name="" value="{{ old('') ?? $user_details->xx }}" />
                        </div>
                        <div class="col-sm-4">
                            <label>Last Name <i class="fal fa-user"></i></label>
                            <input type="text" placeholder="Last name"  name="" value="{{ old('') ?? $user_details->xx }}" />
                        </div>
                        <div class="col-sm-6">
                            <label>Email Address<i class="far fa-envelope"></i> </label>
                            <input type="text" placeholder="JessieManrty@domain.com"  name="" value="{{ old('') ?? $user_details->xx }}" />
                        </div>
                        <div class="col-sm-6">
                            <label>Phone<i class="far fa-phone"></i> </label>
                            <input type="text" placeholder="+7(123)987654"  name="" value="{{ old('') ?? $user_details->xx }}" />
                        </div>
                        <div class="col-sm-6">
