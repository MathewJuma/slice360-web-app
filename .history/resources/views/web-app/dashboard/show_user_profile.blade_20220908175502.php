                    ...
                    <div class="col-md-8">
                        ...
                        <div class="list-main-wrap-header fl-wrap block_box no-vis-shadow">
                            ...
                            <div class="list-main-wrap-title">
                                <h2>
                                    @if (auth()->id() != $user_details->id)
                                        Opportunities by : <span>{{ $user_details->first_name . ' ' . $user_details->last_name }}</span>
                                    @else
                                        My Opportunities
                                    @endif
                        ...
                        <div class="listing-item-container init-grid-items fl-wrap nocolumn-lic" style="margin-top: -20px !important;">
                                ...
                                <div class="box-widget-author fl-wrap">
                                    <div class="box-widget-author-title">
                                        ...
                                        <div class="box-widget-author-title_content">
                                            <a href="user-single.html">{{ $user_details->first_name . ' ' . $user_details->last_name }}</a>
