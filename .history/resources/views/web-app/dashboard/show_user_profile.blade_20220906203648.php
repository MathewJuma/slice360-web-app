...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    <div class="white-bg breadcrumbs inline-breadcrumbs fl-wrap block-breadcrumbs">
        <!-- content-->
                <div class="content" style="margin-top: -30px !important; background-color: #f6f6f6 !important;">
                    <section class="no-top-padding-sec" id="sec1">
                        <div class="container">
