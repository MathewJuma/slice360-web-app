            ...
            @foreach ($all_opportunities as $opportunity)
                ...
                <div class="dashboard-list fl-wrap">
                    <div class="dashboard-message">
                        ...
                        <div class="dashboard-message-text" style="border: 1px solid red;">
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="geodir-category-location clearfix">
                                        <span style="font-size: 9px; color:darkslategray; text-align: left !important;">{{ $opportunity->brief_description }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
