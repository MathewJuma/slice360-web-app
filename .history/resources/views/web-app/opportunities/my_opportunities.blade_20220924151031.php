                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            @if ($opportunity->is_verified === "Yes")
                                                <span class="verified-badge tolt" data-microtip-position="bottom" data-tooltip="Slice360 Verified" style="width: 70px !important; height: 50px; border-radius: 5px !important;">
                                                    Verified
                                                </span>
                                            @else
