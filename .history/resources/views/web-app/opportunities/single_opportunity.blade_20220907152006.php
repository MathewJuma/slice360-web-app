    ...
    <section class="listing-hero-section hidden-section" data-scrollax-parent="true" id="opportunity_hero">
        ...
        <div class="container">
            ...
            <div class="list-single-header_bottom fl-wrap">
                ...
                <div class="list-single-author"> <a href="author-single.html"><span class="author_avatar"> <img alt='' src='{{ asset('web_app/images/avatar/1.jpg') }}'>  </span>By: {{ $opportunity_details->owner_name }}</a></div>
