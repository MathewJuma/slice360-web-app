...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    @php
        ...
        $per_total_score = number_format(($avg_total_score/5)*100), 0); $per_description_score = $avg_description_score/5 ; $per_capital_score = 0.0; $per_category_score = 0.0; $per_timeline_score = 0.0;
