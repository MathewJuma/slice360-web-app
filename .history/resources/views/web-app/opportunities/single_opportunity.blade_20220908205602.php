                        ...
                        <div class="list-single-header list-single-header-inside block_box fl-wrap" id="opportunity_details">
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="list-single-author">
                                    <a href="{{ route('web-app.dashboard.show-user-profile', $opportunity_details->owner_id) }}">
                                        <span class="author_avatar"> <img alt='' src='{{ asset('web_app/images/avatar/1.jpg') }}'>  </span>
