                                        ...
                                        <fieldset>
                                            <div class="review-score-form fl-wrap">
                                                <div class="review-range-container">
                                                    ...
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" name="scores['description']"  data-step="1" value="0">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" name="scores['capital']"  data-step="1"  value="0">
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                    <!-- review-range-item-->
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" name="scores['category']"  data-step="1" value="0" >
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                    <!-- review-range-item-->
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5"  name="scores['timeline']"  data-step="1" value="0">
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                </div>
                                                <div class="review-total">
                                                    <span>
                                                        <input type="text" name="rg_total" data-form="AVG({scores})" value="0">
                                                    </span>
