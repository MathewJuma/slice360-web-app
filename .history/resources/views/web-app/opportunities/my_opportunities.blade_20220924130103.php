                    ...
                    <div class="dashboard-message">
                        <div class="booking-list-contr">
                            ...
                            @if ($opportunity->is_locked === "Yes")
                                <a href="/opportunities/{{ $opportunity->id }}-{{ Str::slug($opportunity->title) }}" class="red-bg tolt" data-microtip-position="left" data-tooltip="Locked"><i class="fal fa-locked"></i></a>
                            @else
