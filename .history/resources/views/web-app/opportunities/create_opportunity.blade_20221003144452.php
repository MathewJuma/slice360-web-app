            ...
            <div class="custom-form">
                ...
                <div class="row">
                    ...
                    <div class="profile-edit-container fl-wrap block_box">
                        <div class="custom-form">
                            <!-- Checkboxes -->
                            <ul class="fl-wrap filter-tags no-list-style ds-tg" style="padding-bottom: -100px !important;">
                                <li style="padding-right: 50px !important;">
                                    <input id="check-aaa5" type="checkbox" name="check" checked>
                                    <label for="check-aaa5">Investors</label>
                                </li>
                                <li style="padding-right: 50px !important;">
                                    <input id="check-bb5" type="checkbox" name="check" checked>
                                    <label for="check-bb5">Donors</label>
                                </li>
                                <li style="padding-right: 50px !important;">
                                    <input id="check-dd5" type="checkbox" name="check">
                                    <label for="check-dd5">Lenders</label>
                                </li>
                                <li style="padding-right: 50px !important;">
                                    <input id="check-cc5" type="checkbox" name="check">
                                    <label for="check-cc5">Incubation</label>
                                </li>
                                <li style="padding-right: 50px !important;">
                                    <input id="check-ff5" type="checkbox" name="check" checked>
                                    <label for="check-ff5">Accelerators</label>
                                </li>
                            </ul>
                            <!-- Checkboxes end -->
                        </div>
