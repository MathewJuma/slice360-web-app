                                                ...
                                                <div class="reviews-comments-item-text fl-wrap">
                                                    <div class="reviews-comments-header fl-wrap">
                                                        ...
                                                        <div class="review-score-user">
                                                            <span class="review-score-user_item" style="margin-left: 25px !important;">{{ $review_score }}</span>
                                                            <div class="listing-rating card-popup-rainingvis" data-starrating2="5" style="padding-right: 100px !imrptant;"></div>
                                                        </div>
                                                    </div>
