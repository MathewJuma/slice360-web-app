                            ...
                            <div class="custom-form">
                                ...
                                <ul class="fl-wrap filter-tags no-list-style ds-tg" style="margin-bottom: -10px !important;" id="opportunity_seeking">
                                    <li style="padding-right: 25px !important;">
                                        <input id="investors" type="checkbox" name="opportunity_seeking">
                                        <label for="investors">Investors</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="donors" type="checkbox" name="opportunity_seeking">
                                        <label for="donors">Donors</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="lenders" type="checkbox" name="opportunity_seeking">
                                        <label for="lenders">Lenders</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="incubation" type="checkbox" name="opportunity_seeking">
                                        <label for="incubation">Incubation</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="acceleration" type="checkbox" name="opportunity_seeking">
                                        <label for="acceleration">Acceleration</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="others" type="checkbox" name="opportunity_seeking">
        ...
        <script type='text/javascript'>
            ...
            $(document).ready(function () {
                ...
                $('#new_opportunity_submit').click(function(){
                    ...
                    var opportunity_seek = $("#tblFruits input[type=checkbox]:checked").length;;

                    if (opportunity_seek == 0 || opportunity_seek > 3) {

                        alert('You can select upto three options');
