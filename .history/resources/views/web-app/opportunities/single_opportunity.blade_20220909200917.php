...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    @php
        ...
        if($total_reviews > 0){
            ...
            $avg_total_score = 0; $avg_description_score = 0; $avg_capital_score = 0; $avg_category_score = 0; $avg_timeline_score = 0;
            ...
            $avg_total_score = $total_score/$total_reviews;
            $avg_description_score = $total_description_score/$total_reviews;
            $avg_capital_score = $total_capital_score/$total_reviews;
            $avg_category_score = $total_category_score/$total_reviews;
            $avg_timeline_score = $total_timeline_score/$total_reviews;
