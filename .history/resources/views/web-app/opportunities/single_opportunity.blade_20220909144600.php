        ...
        <div class="container">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="geodir-category-location fl-wrap">
                            <a href="#">
                                ...
                                <b>{{ $opportunity_details->city . ', ' . $opportunity_details->country_name }}
                            </a>
                        ...
                        <a class="fl-wrap list-single-header-column custom-scroll-link " href="#sec6">
                            <div class="listing-rating-count-wrap single-list-count">
                                ...
                                <div class="listing-rating card-popup-rainingvis"
                                    data-starrating2="{{ $opportunity_details->ratings }}"></div>
                                <br>
            ...
            <div class="list-single-header_bottom fl-wrap">
                ...
                <div class="list-single-author">
                    <a
                        href="{{ route('web-app.dashboard.show-user-profile', $opportunity_details->owner_id . '-' . Str::slug($opportunity_details->owner_name)) }}">
                ...
                <div class="list-single-stats">
                    <ul class="no-list-style">
                        <li><span class="viewed-counter"><i class="fas fa-eye"></i> Viewed -
                                {{ $opportunity_details->viewed }} </span></li>
                        <li><span class="bookmark-counter"><i class="fas fa-bookmark"></i> Followers -
                                {{ $opportunity_details->bookmarked }} </span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="scroll-nav-wrapper fl-wrap">
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                <div class="container float-end" style="width: 480px;">
                    <div class="row float-end" style="border: 1px solid red;">
                        <div class="col col-lg-2  float-end">
                            <a href="{{ route('web-app.opportunities.edit-opportunity', $opportunity_details->id.'-'.Str::slug($opportunity_details->title)) }}" class="scroll-nav-wrapper-opt-btn"> <i class="fas fa-edit"></i> Edit </a>
                        </div>
                        <div class="col-md-auto  float-end">
                            <form action="" method="post" id="opportunity_follow">
                                @csrf
                                <input type="hidden" name="delete_source" value="single_opportunity">
                                <button type="submit" class="scroll-nav-wrapper-opt-btn">
                                    <i class="fas fa-save"></i> Follow
                                </button>
                            </form>
                        </div>
                        <div class="col col-lg-2  float-end">
    ...
    <section class="gray-bg no-top-padding">
        <div class="container">
            ...
            <div class="breadcrumbs inline-breadcrumbs fl-wrap">
                ...
                <a
                    href="/opportunities/{{ $opportunity_details->category_id }}">{{ $opportunity_details->category_name }}</a>
            ...
            <div class="row">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                        ...
                        <div class="list-single-header list-single-header-inside block_box fl-wrap"
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="geodir-category-location fl-wrap">
                                            <a href="#">
                                                <i
                                                    class="fas fa-map-marker-alt"></i>{{ $opportunity_details->city . ', ' . $opportunity_details->country_name }}
                                            </a>
                                            <a href="#"> <i
                                                    class="fal fa-phone"></i>{{ $opportunity_details->owner_mobile }}</a>
                                            <a href="#"><i
                                                    class="fal fa-envelope"></i>{{ $opportunity_details->owner_email }}
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="fl-wrap list-single-header-column  block_box">
                                            <div class="listing-rating-count-wrap single-list-count">
                                                <div class="review-score">
                                                    {{ number_format($opportunity_details->ratings, 1) }}</div>
                                                <div class="listing-rating card-popup-rainingvis"
                                                    data-starrating2="{{ $opportunity_details->ratings }}"></div>
                                                <br>
                                                <div class="reviews-count">{{ $opportunity_details->reviews }} reviews
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="{{ $funding_status_color }}">
                                    <i
                                        class="{{ $funding_status_icon }}"></i>{{ $opportunity_details->funding_status }}
                                </div>
                                <div class="list-single-stats">
                                    <ul class="no-list-style">
                                        ...
                                        <li style="margin-bottom: 5px; margin-top: 5px;">
                                            <span class="bookmark-counter"><i class="fas fa-bookmark"></i> Followers -
                                                {{ $opportunity_details->bookmarked }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="milestone-counter">
                                                <div class="stats animaper">
                                                    <div class="num" data-content="0"
                                                        data-num="{{ $opportunity_details->amount_needed }}"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="inline-facts">
                                            ...
                                            <div class="milestone-counter">
                                                <div class="stats animaper">
                                                    ...
                                                    @endphp
                                                    {{-- custom php code end --}}
                                                    <div class="num" data-content=""
                                                        data-num="{{ $percentage_raised }}"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="inline-facts-wrap gradient-bg" style="min-height: 134px !important;">
                                        <div class="inline-facts">
                                            ...
                                            <div class="milestone-counter">
                                                <div class="stats animaper">
                                                    <div class="num" data-content="0"
                                                        data-num="{{ $opportunity_details->number_of_investors }}">
                                                        {{ $opportunity_details->number_of_investors }}</div>
                                                </div>
                                            </div>
                        ...
                        <x-web-app.opportunities.opportunity-details-card title="Description">
                            <div class="list-single-main-item_content fl-wrap"
                                ...
                                <div class="description-holder scrollbar-inner2 text-left" data-simplebar="init"
                                    data-simplebar-auto-hide="true" style="border: 0px solid red;">
                                    {!! $opportunity_details->detailed_description !!}
                                </div>

                                {{-- show button if there is website url --}}
                                @if ($opportunity_details->webiste_url != '' &&
                                    $opportunity_details->webiste_url != null &&
                                    !empty($opportunity_details->webiste_url))
                                    <a href="{{ $opportunity_details->webiste_url }}" target="_blank"
                                        class="btn color2-bg float-btn" style="margin-top: 30px !important;">Visit
                                        Website<i class="fal fa-chevron-right"></i></a>
                                @endif
                        ...
                        <x-web-app.opportunities.opportunity-details-card title="Gallery / Photos"
                            id="opportunity_gallery">
                            <div class="list-single-main-item_content fl-wrap">
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                @foreach ($other_images_array as $opportunity_images)
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="box-item">
                                                            <img src="{{ asset($opportunity_images) }}"
                                                                alt="">
                                                            <a href="{{ asset($opportunity_images) }}"
                                ...
                                <div class="timeline" style="margin-right: 15px !important;">
                                    <div class="timeline__wrap">
                                        <div class="timeline__items"
                                            style="width: 1680px; height: 432px; transform: translate3d(0px, 0px, 0px);">
                                            <div class="timeline__item timeline__item--top fadeIn"
                                                style="width: 210px; height: 216px;">
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            <h2>
                                                                1. Pitch
                                                                <span class="verified-badge tolt timeline-badge"
                                                                    data-microtip-position="bottom"
                                                                    data-tooltip="Executed">
                                                                    <i class="fal fa-check"></i>
                                                                </span>
                                                            </h2>
                                                            <p>Pivot investor making a pitch about the business
                                                                opportunity on Slice360 and availing all required
                                                                documents for verification process to start.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="timeline__item timeline__item--bottom fadeIn"
                                                style="width: 210px; height: 216px; transform: translateY(216px);">
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            <h2>
                                                            ...
                                                            <p>Slice360 conducts due diligence on the
                                                                investment/business idea pitched, verifies and publishes
                                                                it on the website for public participation.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            <h2>
                                                                3. Fund Raise
                                                                <span class="progress-badge tolt timeline-badge"
                                                                    data-microtip-position="bottom"
                                                                    data-tooltip="In Progress">
                                                                    <i class="fal fa-history"></i>
                                                                </span>
                                                            </h2>
                                                            <p>Investors opt-into and on-board the investment/business
                                                                opportunity published, and start contributing funds to
                                                                raise the required capital.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            <h2>
                                                                4. Company Formation
                                                                <span class="danger-badge tolt timeline-badge"
                                                                    data-microtip-position="bottom"
                                                                    data-tooltip="Not yet">
                                                                    <i class="fal fa-times"></i>
                                                                </span>
                                                            </h2>
                                                            <p>Slice360 registers a smart company, issuing smart
                                                                contracts to each of the participating investors based
                                                                on proportions of their contributions.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>Participating investors work together on project plan and
                                                                project strategies. Slice360 might provide services of
                                                                an expert in the business industry.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>Participating investors starts the investment/business
                                                                implementation phase. Slice360 might provide services of
                                                                an expert in the business industry.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>Participating investors review investment/business
                                                                implementation. Slice360 might provide services of an
                                                                expert in the business industry.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>Participating investors launch the investment/business
                                                                opportunity that has been implemented. Slice360 may help
                                                                with regulations.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>Participating investors continually monitor the running
                                                                on their investments. Slice360 may help with monitoring
                                                                and operations services.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline__item__inner">
                                                    <div class="timeline__content__wrap">
                                                        <div class="timeline__content">
                                                            ...
                                                            <p>If the investment opportunity has a closure clause, then
                                                                Slice360 will help with the closing services, ensuring
                                                                each investor is satisfied.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <button class="timeline-nav-button timeline-nav-button--prev" style="top: 216px;"
                                        disabled="">Previous</button>
                                    <button class="timeline-nav-button timeline-nav-button--next"
                                        style="top: 216px;">Next</button>
                        ...
                        <x-web-app.opportunities.opportunity-details-card title="Item Reviews"
                            id="opportunity_reviews" :reviewCount="$opportunity_details->reviews">
                            <!--reviews-score-wrap-->
                                ...
                                <div class="reviews-comments-wrap">
                                        ...
                                        <div class="reviews-comments-item-text fl-wrap">
                                            ...
                                            <div class="reviews-comments-item-footer fl-wrap">
                                                <div class="reviews-comments-item-date"><span><i
                                                            class="fal fa-calendar-check"></i>12 April 2018</span>
                                                </div>
                                                <a href="#" class="rate-review"><i
                                    ...
                                    <div class="reviews-comments-item">
                                        ...
                                        <div class="reviews-comments-item-text fl-wrap">
                                            ...
                                            <div class="reviews-comments-item-footer fl-wrap">
                                                <div class="reviews-comments-item-date"><span><i
                                                            class="fal fa-calendar-check"></i>03 December 2017</span>
                                                </div>
                                                <a href="#" class="rate-review"><i
                                                        class="fal fa-thumbs-up"></i> Helpful Review <span>4</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @if (Auth::check())
                            ...
                            <x-web-app.opportunities.opportunity-details-card title="Add Review"
                                id="opportunity_reviews_write">
                                <!-- Add Review Box -->
                                        ...
                                        <fieldset>
                                            <div class="review-score-form fl-wrap">
                                                ...
                                                <div class="review-total">
                                                    <span>
                                                        <input type="text" name="rg_total" data-form="AVG({rgcl})"
                                                            value="0">
                                                    </span>
                ...
                <div class="col-md-4" style="margin-bottom: -40px !important;">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                        ...
                        <x-web-app.opportunities.opportunity-details-card title="Opportunity Tags"
                            id="opportunity_tags">
                            <div class="box-widget  fl-wrap" style="min-height: 140px !important;">
                                <div class="box-widget-content" style="margin-top: -10px !important;">
                                    <div class="list-single-tags tags-stylwrap">
                                        ...
                                        <a
                                            href="/opportunities?tag={{ $opportunity_details->category_id }}">{{ $opportunity_details->category_name }}</a>
                                        {{-- make coutry to be part of tags end --}}

                                        {{-- make coutry to be part of tags --}}
                                        <a
                                            href="/opportunities?tag={{ $opportunity_details->country_id }}">{{ $opportunity_details->country_name }}</a>
                                        {{-- make coutry to be part of tags end --}}
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (Auth::check())
                            <!--opt in :: box-widget-item -->
                            <x-web-app.opportunities.opportunity-details-card title="Opt Onto Opportunity"
                                id="opportunity_opt_in">
                                        ...
                                        <form class="add-comment custom-form">
                                            <fieldset>
                                                ...
                                                <div class="listsearch-input-item clact">
                                                    <select data-placeholder="Ticket Type"
                                            ...
                                            <button class="btn color2-bg url_btn float-btn"
                                                onclick="window.location.href='booking.html'">Join Now <i
                                    ...
                                    <div class="box-widget-author-title">
                                        ...
                                        <div class="box-widget-author-title_opt">
                                            ...
                                            <a href="#" class="tolt color-bg cwb" data-microtip-position="top"
                                                data-tooltip="Chat With Agent"><i class="fas fa-comments-alt"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ul class="no-list-style">
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ isset($other_images_array[0]) ? asset($other_images_array[0]) : asset('web_app/images/slice360_blue.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
                                                    ...
                                                    <div class="geodir-category-location fl-wrap"><a href="#"><i
                                                            ...
                                                            Plaza, NJ, USA</a></div>
                                                    <div class="widget-posts-descr-link"><a
                                                            href="#listing.html">Restaurants </a> <a
                                            ...
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ isset($other_images_array[1]) ? asset($other_images_array[1]) : asset('web_app/images/slice360_blue.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
                                            ...
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ isset($other_images_array[2]) ? asset($other_images_array[2]) : asset('web_app/images/slice360_blue.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
                                                    ...
                                                    <div class="geodir-category-location fl-wrap"><a href="#"><i
                                                            ...
                                                            USA</a></div>
                                                    <div class="widget-posts-descr-link"><a
                                                            href="#listing.html">Events</a> </div>
                                                    <div class="widget-posts-descr-score">4.2</div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ isset($other_images_array[3]) ? asset($other_images_array[3]) : asset('web_app/images/slice360_blue.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
