                        ...
                        <div class="custom-form">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="general-input-item">
                                        <input type="text" placeholder="Fund raiser start date (dd/mm/yyy)" name="pledging_start_date"  value="{{ old('pledging_start_date') ?? $opportunity_details->pledging_start_date }}"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="general-input-item">
                                        <input type="text" placeholder="Fund raiser end date (dd/mm/yyy)" name="pledging_end_date" value="{{ old('pledging_end_date') ?? $opportunity_details->pledging_end_date }}"/>
