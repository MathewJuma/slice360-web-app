                    ...
                    <div class="col-md-3">
                        <a class="fl-wrap list-single-header-column custom-scroll-link" href="#opportunity_reviews">
                            <div class="listing-rating-count-wrap single-list-count">
                                <div class="review-score" style="padding-top: 10px !important;">{{ number_format($avg_total_score, 1) }}</div>
                                <div class="listing-rating card-popup-rainingvis" data-starrating2="{{ $avg_total_score }}" style="padding-top: 10px !important;"></div>
                                <br>
                                <div class="reviews-count reviews-count-color">{{ $total_reviews }}&nbsp;&nbsp;reviews</div>
                            </div>
                        </a>
                    </div>
                </div>
