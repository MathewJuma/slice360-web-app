                                        ...
                                        <fieldset>
                                            <div class="review-score-form fl-wrap">
                                                <div class="review-range-container">
                                                    ...
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" id="mathe_checker" name="description_score"  data-step="1" value="0">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" id="mathe_checker" name="capital_score"  data-step="1"  value="0">
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                    <!-- review-range-item-->
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap ">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" id="mathe_checker"  name="category_score"  data-step="1" value="0" >
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                    <!-- review-range-item-->
                                                    <div class="review-range-item">
                                                        ...
                                                        <div class="range-slider-wrap">
                                                            <input type="text" class="rate-range" data-min="0" data-max="5" id="mathe_checker"  name="timeline_score"  data-step="1" value="0">
                                                        </div>
                                                    </div>
                                                    <!-- review-range-item end -->
                                                </div>
                                                <div class="review-total">
                                                    <span>
                                                        <input type="text" name="rg_total" data-form="AVG({mathe_checker})" value="0">
                                                    </span>
