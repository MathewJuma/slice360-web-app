                ...
                @if (Auth::check())
                    <div class="scroll-nav-wrapper-opt-btn custom_submit_buttons_inner">
                        <form action="" method="post" id="opportunity_follow">
                            ...
                            <input type="hidden" name="opportunity_id" value="{{ $opportunity_details->id }}">
                            <button type="submit" class="custom_submit_buttons_inner" id="opportunity_follow_button">
    ...
    @push('custom_javascript')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //process when the "opportunity_follow_button" button is clicked
                $('#opportunity_follow_button').click(function() {
                    alert('follow');
                });
