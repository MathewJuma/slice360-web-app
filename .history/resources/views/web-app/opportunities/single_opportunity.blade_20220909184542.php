                        ...
                        @if (Auth::check())
                            ...
                            <x-web-app.opportunities.opportunity-details-card title="Add Review" id="opportunity_reviews_write">
                                ...
                                <div id="add-review" class="add-review-box">
                                    <!-- Review Comment -->
                                    <form  action="javascript:void(0);" method="post" class="add-comment  custom-form" name="opportunity_review_form" id="opportunity_review_form">
                                        <fieldset>
                                            <div class="review-score-form fl-wrap">
                                                ...
                                                <div class="review-total">
                                                    <span>
                                                        <input type="text" name="total_score" data-form="AVG({scores})" value="0">
                                                    </span>
    ...
    @push('custom_javascript')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //process opportunity review submit
                $('#opportunity_review_submit').click(function(){

                    var form_data = $('#opportunity_review_form').serialize();
