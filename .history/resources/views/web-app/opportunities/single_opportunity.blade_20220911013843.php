        ...
        <div class="container">
            <div class="list-single-header-item  fl-wrap">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a class="fl-wrap list-single-header-column custom-scroll-link normal_link" href="#opportunity_reviews">
                            <div class="listing-rating-count-wrap single-list-count">
                                ...
                                <div class="reviews-count">
                                    <a href="#opportunity_reviews" class="normal_link"><span>{{ $total_reviews }}&nbsp;&nbsp;reviews</span></a>
                                </div>
                            </div>
                        </a>
                    </div>
