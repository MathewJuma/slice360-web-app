                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            @if ($opportunity->is_verified === "Yes")
                                                <span class="verified-badge tolt" data-microtip-position="bottom" data-tooltip="Slice360 Verified" style="margin-top:10px !important; width: 70px !important; height: 15px; border-radius: 5px !important;">
                                                    Verified
                                                </span>
                                            @else
                                                <span class="danger-badge tolt" data-microtip-position="bottom" data-tooltip="Not Verified" style="margin-top:10px !important; width: 70px !important; height: 15px; border-radius: 5px !important; font-size: 0.25rem;">
                                                    Not Verified
                                                </span>
                                            @endif
