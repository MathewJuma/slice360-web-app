    ...
    <section class="listing-hero-section hidden-section" data-scrollax-parent="true" id="opportunity_hero">
        ...
        <div class="container">
            ...
            <div class="list-single-header_bottom fl-wrap">
                ...
                <div class="list-single-author"> <a href="author-single.html"><span class="author_avatar"> <img alt='' src='{{ asset('web_app/images/avatar/1.jpg') }}'>  </span>By: {{ $opportunity_details->owner }}</a></div>
                ...
                <div class="list-single-stats">
                    <ul class="no-list-style">
                        ...
                        <li><span class="bookmark-counter"><i class="fas fa-bookmark"></i> Bookmark - {{ $opportunity_details->bookmarked }} </span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="scroll-nav-wrapper fl-wrap">
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                <a href="#" class="scroll-nav-wrapper-opt-btn"> <i class="fas fa-save"></i> Save </a>
                ...
                <div class="show-more-snopt-tooltip" style="width: 120px !important; border: 0px solid red">
                    <nav class="scroll-nav scroll-init" style="margin-left: 0px !important; border: 0px solid blue">
            ...
            <div class="row">
                ...
                <div class="col-md-8" style="margin-bottom: -40px !important;">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="list-single-stats">
                                    <ul class="no-list-style">
                                        ...
                                        <li style="margin-bottom: 5px; margin-top: 5px;">
                                            <span class="bookmark-counter"><i class="fas fa-bookmark"></i> Bookmark -  {{ $opportunity_details->bookmarked }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <x-web-app-components.opportunities.opportunity-details-card title="Description">
                        ...
                        </x-web-app-components.opportunities.opportunity-details-card>
                        <!-- decription :: list-single-main-item end -->

                        <!-- gallery :: list-single-main-item-->
                        <x-web-app-components.opportunities.opportunity-details-card title="Gallery / Photos" id="opportunity_gallery">
                        ...
                        <x-web-app-components.opportunities.opportunity-details-card title="Timelines" id="opportunity_timeline">
                            <div class="list-single-main-item_content fl-wrap">
                                <!-- timeline-container -->
                        ...
                        <x-web-app-components.opportunities.opportunity-details-card title="Item Reviews" id="opportunity_reviews" :reviewCount="$opportunity_details->reviews">
                            <!--reviews-score-wrap-->
                        ...
                        <x-web-app-components.opportunities.opportunity-details-card title="Add Review" id="opportunity_reviews_write">
                            <!-- Add Review Box -->
                ...
                <div class="col-md-4" style="margin-bottom: -40px !important;">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                        ...
                        <x-web-app-components.opportunities.opportunity-details-card title="Opportunity Tags" id="opportunity_tags">
                        ...
                        <!--opt in :: box-widget-item -->
                        <x-web-app-components.opportunities.opportunity-details-card title="Opt Onto Opportunity" id="opportunity_opt_in">
                        ...
                        <!--box-widget-item -->
                        <x-web-app-components.opportunities.opportunity-details-card title="Slice360 Agent : " >
                            <div class="box-widget">
                        ...
                        <!--box-widget-item -->
                        <x-web-app-components.opportunities.opportunity-details-card title="Similar listings : " >
