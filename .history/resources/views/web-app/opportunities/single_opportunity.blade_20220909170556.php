...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    @php
        ...
        $active_followers_user_id = [];

        //find all user id of followers
        foreach ($opportunity_followers  as $follower){

            $followers_user_id[] = $follower->user_id;

        }

        //dd($followers_user_id);
            ...
            <div class="list-single-header_bottom fl-wrap">
                ...
                <div class="list-single-stats">
                    <ul class="no-list-style">
                        ...
                        <li><span class="bookmark-counter"><i class="fas fa-bookmark"></i> Followers - {{ $opportunity_followers->count() }} </span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                ...
                @if (Auth::check() && $opportunity_details->user_id != auth()->id())
                    ...
                    @if (in_array(auth()->id(), $followers_user_id))
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="list-single-stats">
                                    <ul class="no-list-style">
                                        ...
                                        <li style="margin-bottom: 5px; margin-top: 5px;">
                                            <span class="bookmark-counter"><i class="fas fa-bookmark"></i> Followers -  {{ $opportunity_followers->count() }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
