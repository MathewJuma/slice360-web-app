                ...
                <div class="dashboard-list fl-wrap">
                    <div class="dashboard-message">
                        ...
                        <div class="dashboard-message-text">
                            ...
                            <h4 style="font-size: 10.4px !important; font-weight: bold !important;"><a href="listing-single.html">{{ $opportunity->title }}</a></h4>
                            <div class="geodir-category-location clearfix"><a href="#">{{$opportunity->city.', '.$opportunity->opportunity_country->name }}</a></div>
                        </div>
                    </div>
                </div>
                <!-- dashboard-list end-->
