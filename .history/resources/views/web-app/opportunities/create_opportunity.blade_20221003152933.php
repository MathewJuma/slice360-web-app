    ...
    <form action="/opportunities" enctype="multipart/form-data" method="post" id="new_opportunity_form">
        ...
        <div class="profile-edit-container fl-wrap block_box">
            <div class="custom-form">
                ...
                <button class="btn color2-bg float-btn general-btn" type="submit" id="opportunity_submit">Create Opportunity<i class="fal fa-paper-plane"></i></button>
            </div>
        </div>
    ...
    @push('custom_javascript')
        ...
        <script type='text/javascript'>
            ...
            $(document).ready(function () {
                ...
                $('#opportunity_submit').click(function(){

                    var opportunity_seek = $('#my-form input[name="test"]:checked').size();
