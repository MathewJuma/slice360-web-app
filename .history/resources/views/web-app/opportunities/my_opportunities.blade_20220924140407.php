                    ...
                    <div class="dashboard-message">
                        <div class="booking-list-contr">
                            ...
                            @if ($opportunity->is_locked === "Yes")
                                <a href="{{ route('web-app.opportunities.show-opportunity', $opportunity->id.'-' }}" class="yellow-bg tolt" data-microtip-position="left" data-tooltip="Locked"><i class="fal fa-lock"></i></a>

                                {{-- check if published --}}
                                @if ($opportunity->is_published === "Yes")
                                    <a href="#" class="green-bg tolt" data-microtip-position="left" data-tooltip="Published"><i class="fal fa-check-circle"></i></a>
                                @endif
