            ...
            <div class="list-single-header_bottom fl-wrap">
                ...
                <div class="list-single-stats">
                    <ul class="no-list-style">
                        ...
                        <li><span class="bookmark-counter"><i class="fas fa-bookmark"></i> Following - {{ $opportunity_details->bookmarked }} </span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="scroll-nav-wrapper fl-wrap">
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                ...
                @if (Auth::check())
                    <a href="#" class="scroll-nav-wrapper-opt-btn"> <i class="fas fa-save"></i> Follow </a>
                @endif
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="list-single-stats">
                                    <ul class="no-list-style">
                                        ...
                                        <li style="margin-bottom: 5px; margin-top: 5px;">
                                            <span class="bookmark-counter"><i class="fas fa-bookmark"></i> Following -  {{ $opportunity_details->bookmarked }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
