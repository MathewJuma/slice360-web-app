                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-form">
                                    ...
                                    <div class="general-input-item">
                                        <textarea cols="40" rows="3" name='detailed_description' id="detailed_description" placeholder=""  name="" />{{ old('detailed_description') ?? $opportunity_details->detailed_description }}</textarea>
