                                    ...
                                    <div class="listsearch-input-item">
                                        <select data-placeholder="Categories" class="chosen-select no-search-select" name="category_id">
                                            ...
                                            @foreach ($all_categories as $category)
                                                <option value="{{ $category->id }}" {{ $category->id == $opportunity_details->category ? "selected" : "" }}>{{ $category->name }}</option>
                                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-form">
                                    ...
                                    <div class="general-input-item">
                                        <textarea cols="40" rows="3" name='detailed_description' id="detailed_description" placeholder="{{ $opportunity_details->detailed_description }}"  name="" />{{ old('detailed_description') ?? $opportunity_details->detailed_description }}</textarea>
