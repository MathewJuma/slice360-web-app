                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="profile-edit-container fl-wrap block_box">
                            <div class="custom-form">
                                <!-- Checkboxes -->
                                <ul class="fl-wrap filter-tags no-list-style ds-tg" style="margin-bottom: -10px !important;" id="opportunity_seeking">
                                    <li style="padding-right: 25px !important;">
                                        <input id="investors" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="investors">Investors</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="donors" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="donors">Donors</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="lenders" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="lenders">Lenders</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="incubation" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="incubation">Incubation</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="acceleration" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="acceleration">Acceleration</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="others" class="opportunity_seeking" type="checkbox" name="opportunity_seeking">
                                        <label for="others">Others</label>
                                    </li>
                                </ul>
                                <!-- Checkboxes end -->
                            </div>
                            <div class="seeking_error error">Please select atleast one seeking option</div>
                        </div>
                        <!-- profile-edit-container end-->
                    </div>
                </div>
        ...
        <script type='text/javascript'>
            ...
            $(document).ready(function () {
                ...
                $('.opportunity_seeking').click(function(){
                    ...
                    var opportunity_seeking = $('#opportunity_seeking input[name="opportunity_seeking"]:checked').length();

                    alert(opportunity_seeking);

                });

                //what happens when the submit button is clicked
                $('#new_opportunity_submit').click(function(){
