...
<x-web-app.dashboard.dashboard-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    @if (count($all_opportunities) > 0)
        ...
        <div class="dashboard-list fl-wrap" style="margin-bottom: 10px !important;">
                    <div class="dashboard-message" style="width: 100px !important; border: 1px solid red;">
                        <div class="dashboard-message-text" style="border: 1px solid blue;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8" style="text-align:center !important; padding-top: 10px !important;">
