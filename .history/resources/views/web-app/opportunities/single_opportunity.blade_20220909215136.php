                    ...
                    <div class="col-md-3">
                        <a class="fl-wrap list-single-header-column custom-scroll-link " href="#sec6">
                            <div class="listing-rating-count-wrap single-list-count">
                                ...
                                <br>
                                <div class="reviews-count">{{ $total_reviews }} reviews</div>
                            </div>
                        </a>
                    </div>
                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-12 mt-3 mb-4">
                                            <p style="text-align:center !important; font-size: 14px; color: #325096 !important;">
                                                ...
                                                This opportunity has not been reviewed by anyone. Be the first reviewer!
                                            </p>
                                        </div>
                                </div>
                                        ...
                                        <form action="javascript:void(0);" method="post" id="opportunity_review_form" class="add-comment  custom-form" name="opportunity_review_form" >
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="list-single-main-item_content fl-wrap">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <button class="btn  color2-bg float-btn" type="submit" id="opportunity_review_submit">
