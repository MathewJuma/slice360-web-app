                    ...
                    <div class="col-md-3">
                        <a class="fl-wrap list-single-header-column custom-scroll-link" href="#opportunity_reviews">
                            <div class="listing-rating-count-wrap single-list-count">
                                ...
                                <div class="listing-rating card-popup-rainingvis" data-starrating2="{{ $avg_total_score }}" style="margin-top: 7px !important;"></div>
                                <br>
                                <div class="reviews-count reviews-count-color" style="margin: 7px 0px 0px -25px !important;">{{ $total_reviews }}&nbsp;&nbsp;reviews</div>
                            </div>
                        </a>
                    </div>
                </div>
                                        ...
                                        <div class="fl-wrap list-single-header-column block_box">
                                            <a class="custom-scroll-link" href="#opportunity_reviews">
                                                <div class="listing-rating-count-wrap single-list-count">
                                                    ...
                                                    <div class="listing-rating card-popup-rainingvis" data-starrating2="{{ $avg_total_score }}" style="margin-top: 7px !important;"></div>
                                                    <br>
                                                    <div class="reviews-count reviews-count-color-dark" style="margin: 7px 0px 0px -25px !important;">{{ $total_reviews }}&nbsp;&nbsp;reviews</div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
