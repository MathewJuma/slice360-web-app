    ...
    <div class="scroll-nav-wrapper fl-wrap">
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                <a href="{{ route('web-app.opportunities.edit-opportunity', $opportunity_details->id) }}" class="scroll-nav-wrapper-opt-btn"> <i class="fas fa-edit"></i> Edit </a>
