            ...
            <div class="row">
                ...
                <div class="col-md-8" style="margin-bottom: -40px !important;">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                        ...
                        @if ($opportunity_details->is_fund_raising == "Yes")
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="inline-facts-wrap gradient-bg" style="min-height: 134px !important;">
                                            <div class="inline-facts">
                                                ...
                                                <h6>Total Investors/Donors Participating</h6>
                                            </div>
                                            <div class="stat-wave">
                                                <svg viewbox="0 0 100 25">
                ...
                <div class="col-md-4" style="margin-bottom: -40px !important;">
                    ...
                    <div class="list-single-main-wrapper fl-wrap">
                        ...
                        <x-web-app.opportunities.opportunity-details-card title="Opportunity Seeking" id="opportunity_seeking">
                            <div class="box-widget  fl-wrap" style="min-height: 100px !important;">
                                <div class="box-widget-content" style="margin-top: -10px !important;">

                                    @if ($opportunity_seeking->isEmpty())
                                        <span class="current-breadcrumbs" style="font-size: 24px !important;">
                                            Seeking Details Not Available
                                        </span>
                                    @else

                                        <div class="list-single-tags tags-stylwrap">

                                            {{-- add opportunity seeking --}}
                                            @foreach ( $opportunity_seeking as $seeking)

                                                <a href="/opportunities?tag={{ $seeking->seeking_name }}">{{ ucfirst($seeking->seeking_name) }}</a>

                                            @endforeach
                                            {{-- add opportunity seeking end--}}
