        ...
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                ...
                @if ($opportunity_details->user_id == auth()->id())
                    <div href="{{ route('web-app.opportunities.edit-opportunity', $opportunity_details->id.'-'.Str::slug($opportunity_details->title)) }}" class="scroll-nav-wrapper-opt-btn"> <i class="fas fa-edit"></i> Edit </div>
                @endif
                {{-- only show if user_id is equal auth()->id() end --}}

                {{-- show only if user is logged in --}}
                @if (Auth::check())
                    <div class="scroll-nav-wrapper-opt-btn" style="margin-right: 3px !important;"> <i class="fas fa-save"></i> Follow </div>
                @endif
