            ...
            <div class="scroll-nav-wrapper-opt">
                ...
                @else
                    ...
                    @if ($opportunity_details->user_id == auth()->id() && $opportunity_details->is_published == "Yes" )
                        <a href="{{ route('web-app.opportunities.show-opportunity', $opportunity_details->id.'-'.Str::slug($opportunity_details->title)) }}" class="scroll-nav-wrapper-opt-btn custom_submit_buttons_published disabled"> <i class="fas fa-check-circle"></i> Published </a>
                    @else
                        <a href="{{ route('web-app.opportunities.show-opportunity', $opportunity_details->id.'-'.Str::slug($opportunity_details->title)) }}" class="scroll-nav-wrapper-opt-btn custom_submit_buttons_locked disabled"> <i class="fas fa-lock"></i> Locked </a>
                    @endif
