...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories'>
    ...
    @php
        ...
        //dd($opportunity_followers);

        //this array holds all ID of opportunity followes
        $active_followers = [];
                                                ...
                                                <div class="reviews-comments-item-text fl-wrap">
                                                    <div class="reviews-comments-header fl-wrap">
                                                        ...
                                                        <div class="review-score-user">
                                                            <span class="review-score-user_item" style="margin-left: 50px !important;">{{ $review_score }}</span>
                                                            <div class="listing-rating card-popup-rainingvis" data-starrating2="{{ $review_score }}" style="marging-right: 100px !imrptant;"></div>
                                                        </div>
                                                    </div>
                                                    <p>{{ $review_description }}</p>
                                                    <div class="reviews-comments-item-footer fl-wrap">
                                                        <div class="reviews-comments-item-date"><span><i class="fal fa-calendar-check"></i> {{ date_format($created_at, "d/m/Y") }} </span></div>
