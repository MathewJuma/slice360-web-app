                    ...
                    <div class="dashboard-message">
                        <div class="booking-list-contr">
                            ...
                            @else
                                ...
                                <a href="{{ route('web-app.opportunities.show-opportunity', $opportunity->id.'-'.Str::slug($opportunity->title)) }}" class="color-bg tolt" data-microtip-position="left" data-tooltip="Edit"><i class="fal fa-edit"></i></a>
