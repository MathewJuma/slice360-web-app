                            ...
                            <div class="custom-form">
                                ...
                                <ul class="fl-wrap filter-tags no-list-style ds-tg" style="margin-bottom: -10px !important;">
                                    <li style="padding-right: 25px !important;">
                                        <input id="investors" type="checkbox" name="check">
                                        <label for="investors">Investors</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="donors" type="checkbox" name="check">
                                    ...
                                    <li style="padding-right: 25px !important;">
                                        <input id="acceleration" type="checkbox" name="check">
                                        <label for="acceleration">Acceleration</label>
                                    </li>
                                    <li style="padding-right: 25px !important;">
                                        <input id="others" type="checkbox" name="check">
