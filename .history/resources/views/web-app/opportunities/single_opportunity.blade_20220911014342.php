                    ...
                    <div class="col-md-3">
                        <a class="fl-wrap list-single-header-column custom-scroll-link" href="#opportunity_reviews">
                            <div class="listing-rating-count-wrap single-list-count">
                                ...
                                <div class="listing-rating card-popup-rainingvis" data-starrating2="{{ $avg_total_score }}" style="margin-top: 10px !important;"></div>
                                <br>
                                <br>
                                <div class="reviews-count reviews-count-color" style="margin-left: 0px !important;">{{ $total_reviews }}&nbsp;&nbsp;reviews</div>
                            </div>
                        </a>
                    </div>
                </div>
