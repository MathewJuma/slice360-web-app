    ...
    <div class="scroll-nav-wrapper fl-wrap">
        <div class="container">
            ...
            <div class="scroll-nav-wrapper-opt">
                <div class="row" style="border: 1px solid red; width: 500px !important;">
                    ...
                    @if ($opportunity_details->user_id == auth()->id())
                        <div class="col-md-3" style="border: 1px solid blue;">
                            <a href="{{ route('web-app.opportunities.edit-opportunity', $opportunity_details->id.'-'.Str::slug($opportunity_details->title)) }}" class="scroll-nav-wrapper-opt-btn" style="margin-left: 0px !important; margin-right: 0px !important;">
                    ...
                    <div class="col-md-4" style="border: 1px solid blue;">
                        ...
                        <form action="" method="post" id="opportunity_follow">
                            ...
                            <button type="submit" class="scroll-nav-wrapper-opt-btn" style="margin-left: 0px !important; margin-right: 0px !important;">
