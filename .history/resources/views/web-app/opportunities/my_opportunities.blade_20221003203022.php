                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            @if ($opportunity->is_verified === "Yes")
                                                <span class="verified-badge tolt badge-content" data-microtip-position="bottom" data-tooltip="Slice360 Verified">
                                                    Verified
                                                </span>
                                            @else
                                                <span class="danger-badge tolt badge-content" data-microtip-position="bottom" data-tooltip="Not Verified">
                                                    Not Verified
                                                </span>
                                            @endif
