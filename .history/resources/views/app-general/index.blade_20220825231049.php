...
<x-app-general.main-web-app-layout :all_countries="$all_countries" :all_categories="$all_categories">
    ...
    <x-app-general.hero-main title="Grow your wealth" description="Discover investment opportunities across the globe that align with your vision" :countries="$all_countries" :categories="$all_categories"/>
