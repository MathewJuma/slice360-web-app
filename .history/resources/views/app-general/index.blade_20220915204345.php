...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories' :user_details='[]'>
    ...
    <section  class="gray-bg hidden-section particles-wrapper">
        <div class="container">
                        ...
                        <div class="col-sm-4">
                            <div class="listing-item-grid">
                                ...
                                <div class="listing-counter color2-bg">
                                    <span>{{ $category->category_opportunities_count }}</span> {{ $category->name }}
                                </div>
                                <div class="listing-item-grid_title">
                                    <h4><a href="/opportunities?interest=&category_id={{ $category->id }}&country_id=All+Locations">Opportunities in {{ $category->name }}</a></h4>
            ...
            <a href="{{ route('web-app.opportunities.list-opportunities') }}" class="btn dec_btn   color2-bg">View All Categories<i class="fal fa-arrow-alt-right"></i></a>
        </div>
    </section>
