...
<x-app-general.main-web-app-layout :all_countries='$all_countries' :all_categories='$all_categories' :user_details='[]'>
    ...
    <section class="parallax-section small-par" data-scrollax-parent="true">
        @php
            ...
            $first_date = strtotime(date('01-m-Y 00:00:00')); // hard-coded '01' for first day
            $last_date  = strtotime(date('t-m-Y 23:59:59')); //last date of the current month

            //dd($last_day_this_month);
            ...
            foreach ($all_opportunities as $opportunity) {
                ...
                if($created_at >= $first_day_this_month && $created_at <= $last_day_this_month){
                    $date[] =  $first_day_this_month . ' <= ' . $created_at .' >='.$last_day_this_month;
                }
