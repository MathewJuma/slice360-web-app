    ...
    <section>
        <div class="container big-container">
            ...
            <div class="fl-wrap">
                ...
                <div class="listing-item-container init-grid-items fl-wrap nocolumn-lic four-columns-grid" style="border:0px solid red; margin-top: -25px !important; margin-bottom: -10px !important;">

                    @if (count($all_opportunities) == 0)
                        <div class="section-title" style="padding-top: 50px !important;">
                            <h2 style="color: #325096 !important;">No popular investment opportunities found!</h2>
                        </div>
                    @else
