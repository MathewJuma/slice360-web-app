...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //User::factory()->create(['full_name' => 'Betty', 'last_name' => 'Maneno',  'username' => 'BManeno', 'email' => 'bmaneno@gmail.com', 'phone'=>'+254727074109', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Frida', 'last_name' => 'Mukei',  'username' => 'FMukei', 'email' => 'fmukei@gmail.com', 'phone'=>'+254727074110', 'password' => bcrypt('123456')]);
        //User::factory()->create(['full_name' => 'Kelly', 'last_name' => 'Makwaro',  'username' => 'KMakwaro', 'email' => 'kmakwaro@gmail.com', 'phone'=>'+254727074111', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Lucas', 'last_name' => 'Otieno',  'username' => 'LOtieno', 'email' => 'lotieno@gmail.com', 'phone'=>'+254727074113', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Nichole', 'last_name' => 'Amani',  'username' => 'NAmani', 'email' => 'namani@gmail.com', 'phone'=>'+254727074114', 'password' => bcrypt('123456')]);
