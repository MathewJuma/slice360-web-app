...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::factory()->create(['name' => 'Transport', 'category_note'=>'People and goods are constantly moving, whether by land, air or water. Find your peers and make your dream investment become a reality.', 'description' => 'Category for all transport opportunities', 'status' => '1']);
