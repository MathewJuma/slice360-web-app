...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory()->create(['full_name' => 'Mathew Juma', 'username' => 'MJuma', 'email' => 'athias85@gmail.com', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Betty Maneno', 'username' => 'BManeno', 'email' => 'bmaneno@gmail.com', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Frida Mukei', 'username' => 'FMukei', 'email' => 'fmukei@gmail.com', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Kelly Makwaro', 'username' => 'KMakwaro', 'email' => 'kmakwaro@gmail.com', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Lucas Otieno', 'username' => 'LOtieno', 'email' => 'lotieon@gmail.com', 'password' => bcrypt('123456')]);
        User::factory()->create(['full_name' => 'Nichole Amani', 'username' => 'NAmani', 'email' => 'namani@gmail.com', 'password' => bcrypt('123456')]);
