...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory()->create(['first_name' => 'Super', 'last_name' => 'Administrator', 'username' => 'Super.Admin', 'email' => 'admin@slice360.com', 'is_admin'=>'1', 'phone'=>'+254727074108', 'password' => bcrypt('123456')]);
