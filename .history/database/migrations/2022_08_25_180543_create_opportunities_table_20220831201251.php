...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opportunities', function (Blueprint $table) {
            ...
            $table->string('reviews')->default(0)->nullable();
            $table->decimal('ratings' ,3, 1)->default(0)->nullable();
            $table->integer('viewed')->default(0)->nullable();
            $table->integer('bookmarked')->default(0)->nullable();
            $table->boolean('verified')->default(0); //default not verified
            $table->string('owner')->default('Slice 360')->nullable();
            $table->string('owner_mobile')->default('+254 100 909959')->nullable();
            $table->string('owner_email')->default('founders@slice360.io')->nullable();
