...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opportunity_reviews', function (Blueprint $table) {
            ...
            $table->enum('capital_score', ['0', '1', '2', '3', '4', '5'])->default('0')->nullable();
            $table->enum('category_score', ['0', '1', '2', '3', '4', '5'])->default('0')->nullable();
            $table->enum('timeline_score', ['0', '1', '2', '3', '4', '5'])->default('0')->nullable();
            $table->enum('total_score', ['0', '1', '2', '3', '4', '5'])->default('0')->nullable();
