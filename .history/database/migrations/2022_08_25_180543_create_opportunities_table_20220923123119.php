...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opportunities', function (Blueprint $table) {
            ...
            $table->enum('open_for_funding', ['Active', 'Inactive'])->default('Inactive')->nullable(); //default not active
            ...
            $table->enum('verified', ['Yes', 'No'])->default('No'); //default not active
            $table->enum('locked', ['Yes', 'No'])->default('No'); //default not active
            $table->enum('published', ['Yes', 'No'])->default('No'); //default not active
