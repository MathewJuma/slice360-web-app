...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('opportunities', function (Blueprint $table) {
            ...
            $table->enum('opportunity_published', ['Yes', 'No'])->default('No')->nullable(); //default not active
            $table->enum('opportunity_locked', ['Yes', 'No'])->default('No')->nullable(); //default not active
