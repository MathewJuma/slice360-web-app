...
class OpportunityFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $random_status = array_rand($status);
        $selected_status = $status[$random_status];
        ...
        $open_for_pledging = array_rand(['Active', 'Inactive'], 1);
        $open_for_funding = $open_for_pledging == 'Active' ? "Inactive" : array_rand(['Active', 'Inactive'], 1);
        ...
        return [
            ...
            'click_views' => 0,
            'status' => array_rand(['Active', 'Inactive'], 1),
        ];
    }
