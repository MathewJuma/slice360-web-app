...
Route::controller(OpportunitiesController::class)->prefix('/opportunities')->name('web-app.opportunities.')->group(function () {
    ...
    Route::get('/admin_opportunities_page', 'adminOpportunitiesPage')->name('admin-opportunities-page')->middleware('auth');
    Route::get('/admin_fetch_opportunities', 'adminFetchOpportunities')->name('admin-fecth-opportunities')->middleware('auth');
