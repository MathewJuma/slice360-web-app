...
Route::controller(UsersController::class)->name('app-general.users.')->group(function () {
    Route::post('/login-users', 'loginUser')->name('register-user');
    Route::post('/register-users', 'registerUser')->name('register-user');
});
...
Route::controller(OpportunitiesController::class)->name('web-app.opportunities.')->group(function () {
    ...
    Route::get('opportunities/{opportunity}/edit', 'editOpportunity')->name('edit-opportunity');
