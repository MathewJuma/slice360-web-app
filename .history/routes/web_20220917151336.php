 ...
 */
Route::controller(AdminController::class)->prefix('/admin')->name('app-general.admin.')->group(function () {
    Route::get('/index/{user}/', 'mainDashboard')->name('main-admin-dashboard');
});
...
Route::controller(DashboardController::class)->prefix('/dashboard')->name('web-app.dashboard.')->group(function () {
    Route::get('/index/{user}/', 'mainDashboard')->name('main-dashboard');
