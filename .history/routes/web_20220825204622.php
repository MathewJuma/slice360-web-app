...
Route::controller(OpportunitiesController::class)->name('web-app.opportunities.')->group(function () {
    ...
    Route::get('/opportunities/{opportunity_id}/edit', 'edit')->name('edit-single-opportunity');
    Route::post('/opportunities', 'storeNewOpportunity')->name('store-new-opportunity');
    Route::patch('/opportunities/{opportunity}', 'update')->name('update-single-opportunity');
    Route::delete('/opportunities/{opportunity}', 'destroy')->name('delete-single-opportunity');
});