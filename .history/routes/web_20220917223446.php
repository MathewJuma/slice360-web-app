 ...
 */
Route::controller(AdminController::class)->prefix('/admin')->name('admin-app.dashboard.')->group(function () {
    Route::get('/index/{user}/', 'mainDashboard')->name('admin-main-dashboard')->middleware(['auth', 'isAdmin']);
});
