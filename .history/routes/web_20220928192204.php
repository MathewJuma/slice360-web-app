...
use App\Http\Controllers\web_app\BlogController;
 ...
 * - actual routes for accessing CRUD functionality for opportunities
 */
Route::controller(BlogController::class)->prefix('/blog')->name('web-app.blog.')->group(function () {
    Route::get('', 'index')->name('blog-listing');
    Route::get('/{slug}', 'show')->name('blog-single');
});
