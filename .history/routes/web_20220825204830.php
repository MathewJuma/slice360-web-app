...
Route::controller(OpportunitiesController::class)->name('web-app.opportunities.')->group(function () {
    Route::get('/opportunities', 'listOpportunities')->name('list-all-opportunities');
    Route::get('/opportunities/create', 'createOpportunity')->name('create-new-opportunity');
    Route::post('/opportunities', 'storeOpportunity')->name('store-new-opportunity');
    Route::get('/opportunities/{opportunity}', 'showOpportunity')->name('show-single-opportunity');
    Route::get('/opportunities/{opportunity_id}/edit', 'editOpportunity')->name('edit-single-opportunity');
    Route::patch('/opportunities/{opportunity}', 'updateOpportunity')->name('update-single-opportunity');
    Route::delete('/opportunities/{opportunity}', 'deleteSingleOpportunity')->name('delete-single-opportunity');
});