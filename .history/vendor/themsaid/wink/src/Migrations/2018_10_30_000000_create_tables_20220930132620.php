...
class CreateTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('wink_post_comments', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('post_id');
            $table->string('author');
            $table->string('email');
        ...
        Schema::create('wink_subscriptions', function (Blueprint $table) {
            $table->uuid('id')->primary();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('wink_subscriptions');
    }
}
