...
class UserProfile extends Model
{
    ...
    //defines the relationship between a user profile and the profile's following
    public function user_profile_following()
    {
        return $this->hasMany(UserProfileFollowing::class, 'profile_id')->orderBy('created_at', 'DESC'); //each user profile has many followings
    }
