...
class UserProfile extends Model
{
    ...
    {
        return $this->hasOne(UserProfileBanner::class, 'profile_id')->orderBy('created_at', 'DESC'); //each opportunity has many banner images
    }
    ...
    {
        return $this->hasOne(UserProfileImage::class, 'profile_id')->orderBy('created_at', 'DESC'); //each opportunity has many other images
    }
