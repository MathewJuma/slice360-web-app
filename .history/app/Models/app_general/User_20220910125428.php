...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(UserFollowing::class, 'user_id'); //each user has many user followings
    }


    //defines a relationship between a user and user followers
    public function user_followers()
    {
        return $this->hasMany(UserFollowing::class, 'follower_id'); //each user has many user followings
    }
