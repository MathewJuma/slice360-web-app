...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Opportunity::class, 'user_id')->orderBy('created_at', 'DESC'); //each user has many opportunities
    }
    ...
    {
        return $this->hasOne(UserTestimonial::class, 'user_id'); //each user has one user profile
    }


    //defines a relationship between a user and intouch messages - send
    ...
    //defines a relationship between a user and intouch messages - receive
    public function user_intouch_messages_recieve()
    {
        return $this->hasMany(UserIntouchMessage::class, 'receiver_id'); //each user can receive many intouch messages
    }
