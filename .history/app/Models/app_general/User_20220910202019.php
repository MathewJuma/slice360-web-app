...
class User extends Authenticatable
{
    ...
    //defines a relationship between a user and other users being followed
    public function user_following()
    {
        return $this->hasMany(UserFollowing::class, 'followed_by_id'); //each user has many user followings
    }
    ...
    {
        return $this->hasMany(UserFollowing::class, 'following_id'); //each user has many followers
    }
