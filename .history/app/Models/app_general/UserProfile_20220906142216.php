...
class UserProfile extends Model
{
    ...
    {
        return $this->hasMany(UserProfileBanner::class, 'profile_id')->orderBy('created_at', 'DESC'); //each opportunity has many banner images
    }
    ...
    {
        return $this->hasMany(UserProfileImage::class, 'profile_id')->orderBy('created_at', 'DESC'); //each opportunity has many other images
    }
