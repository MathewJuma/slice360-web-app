...
class Opportunity extends Model implements Viewable
{
    ...
    public function toSearchableArray()
    {
        ...
        //$country = $this->only(['id', 'title', 'brief_description', 'detailed_description']);
        $array = $this->only(['id', 'title', 'brief_description', 'detailed_description'])->with("opportunity_category")->with("opportunity_country")->where("id", $this->id)->first()->toArray();
        return $array;
