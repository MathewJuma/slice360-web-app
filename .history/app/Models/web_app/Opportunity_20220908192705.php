...
class Opportunity extends Model
{
    ...
    {
        return $this->belongsTo(User::class); //each opportunity belongs to a user
    }

    // //defines a relationship between an opportunities and a user
    // public function opportunity_user_profile()
    // {
    //     return $this->hasOneThrough(UserProfile::class, User::class, 'id', 'user_id'); //each opportunity belongs to a user
    // }

    //defines a relationship between an opportunities and a user
    public function opportunity_user_profile_banner()
    {
        return $this->hasOneThrough(UserProfileBanner::class, UserProfile::class, 'id', 'profile_id'); //each opportunity belongs to a user
    }

    //defines a relationship between an opportunities and a user
    public function opportunity_user_profile_image()
    {
        return $this->hasOneThrough(UserProfileImage::class, UserProfile::class, 'id', 'profile_id'); //each opportunity belongs to a user
    }
