...
class Opportunity extends Model
{
    ...
    {
        return $this->hasMany(OpportunityReview::class, 'opportunity_id')->orderBy('created_at', 'DESC'); //each opportunity has many timelines
    }
    ...
    {
        return $this->hasMany(OpportunityFollowing::class, 'opportunity_id')->orderBy('created_at', 'DESC'); //each opportunity has many timelines
    }
