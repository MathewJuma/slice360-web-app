...
class Opportunity extends Model implements Viewable
{
    ...
    //defines the relationship between an opportunity and seeking
    public function opportunity_seeking()
    {
        return $this->hasMany(OpportunitySeekings::class, 'opportunity_id')->orderBy('created_at', 'DESC'); //each opportunity has many banner images
    }
