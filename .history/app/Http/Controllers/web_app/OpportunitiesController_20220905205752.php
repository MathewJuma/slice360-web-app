...
class OpportunitiesController extends Controller
{
    ...
    public function myOpportunities()
    {
        ...
        $all_opportunities = Opportunity::whereIn('user_id', $user_details)->with(['opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->latest()->paginate(10);
