...
class OpportunitiesController extends Controller
{
    ...
    public function storeOpportunity(Request $request)
    {
        ...
        //5. validate if request has file named banner_image
        if ($request->hasFile('banner_images')) {

            //5.1 image settings for processing
            $image_settings = [
            ...
            //5.2 process opportunity images and return the file path
            $this->processOpportunityImages($request, $new_opportuntiy, $image_settings);
        }

        //6. check if request has other images
        ...
        //7. redirect to a page showing the created opportunity
    ...
    public function updateOpportunity(Request $request, Opportunity $opportunity)
    {
        ...
        //2. ensure date format are database ready
        $opportunity_data['pledging_start_date'] = Carbon::createFromFormat('d/m/Y', $request['pledging_start_date'])->format('Y-m-d');
        $opportunity_data['pledging_end_date'] = Carbon::createFromFormat('d/m/Y', $request['pledging_end_date'])->format('Y-m-d');
