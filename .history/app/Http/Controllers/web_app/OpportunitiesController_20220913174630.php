...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
        ...
        $all_opportunities = views(Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images']))->count();
    ...
    public function showOpportunity(Request $request, Opportunity $opportunity)
    {
        ...
        if(Cookie::get($cookie_name) == ''){//check if cookie is set
            ...
            $opportunity_details['views_count'] = views($opportunity)->count(); //count how many times this opportunity has been viewed
