 ...
 */
    ...
    public function myOpportunities()
    {
        ...
        $all_opportunities = Opportunity::whereIn('user_id', $user)->with(['opportunity_country', 'opportunity_category', 'opportunity_seeking', 'opportunity_banner_images', 'opportunity_other_images'])->orderBy('id', 'DESC')->paginate(6, '*', 'my-opportunities');
