...
class DashboardController extends Controller
{
    ...
    public function editUserProfile(User $user)
    {
        ...
        //$user_profile_images = UserProfile::whereIn('id', $user_details->user_profile->id)->with(['user_profile_banner', 'user_profile_image'])->first();

        dd($user_details->user_profile->id);
