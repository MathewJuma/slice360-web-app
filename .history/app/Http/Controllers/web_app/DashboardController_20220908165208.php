...
class DashboardController extends Controller
{
    ...
    public function showUserProfile(User $user){
        ...
        if($user_details->user_profile !== NULL){
            ...
            $user_details['banner_image'] = $this->processImageCollection($user_profile_images->opportunity_banner_images);
            $user_details['profile_image'] = $this->processImageCollection($user_profile_images->opportunity_other_images);
