...
class DashboardController extends Controller
{
    ...
    public function showUserProfile(User $user){
        ...
        if($user_details->user_profile !== NULL){
            ...
            $user_details['banner_image'] = $this->processImageCollection($opportunity_details->opportunity_banner_images);
            $user_details['profile_images'] = $this->processImageCollection($opportunity_details->opportunity_other_images);
