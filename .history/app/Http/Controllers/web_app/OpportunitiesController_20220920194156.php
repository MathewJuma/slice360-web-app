...
class OpportunitiesController extends Controller
{
    ...
    public function allOpportunities()
    {
        ...
        $user_details = User::with(['user_profile', 'user_opportunities'])->get();

        //3. fetch all current user's opportunities
        $all_opportunities = Opportunity::with(['opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->latest()->paginate(6, '*', 'my-opportunities');
