...
class DashboardController extends Controller
{
    ...
    public function showUserProfile(User $user){
        ...
        if($user_details->user_profile !== NULL){
            ...
            $user_details['banner_image'] = $this->processImageCollection($user_profile_images->user_profile_banner);
            $user_details['profile_image'] = $this->processImageCollection($user_profile_images->user_profile_image);
    ...
    protected function processImageCollection($images_collection, $image_type)
    {
        ...
        if ($images_collection == NULL) {
            ...
            //images_path
            $banner_images_path = 'web_app/images/avatar/1_1.jpg';
            //image array
