...
class OpportunitiesController extends Controller
{
    ...
    public function updateOpportunity(Request $request, Opportunity $opportunity)
    {
        ...
        //2. update the opportunity with the request data
        $opportunity->update($request_data);

        //3. redirect to edited listing with message
        return redirect('/opportunities/' . $opportunity->id)->with('message', 'Listing updated successfully');
    }
