...
class OpportunitiesController extends Controller
{
    ...
    public function myOpportunities()
    {
        ...
        //4. fetch all user opportunities
        //$all_opportunities = User::find($user_id)->user_opportunities;
        $all_opportunities = Opportunity::whereIn('user_id', $user_details)->paginate(10);
