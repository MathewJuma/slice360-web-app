...
class DashboardController extends Controller
{
    ...
    public function updateUserProfile(Request $request, User $user)
    {
        ...
        $user_data['middle_name'] = $request_data['middle_name'];
        $user_data['last_name'] = $request_data['last_name'];
        $user_data['username'] = ucfirst(substr($request_data['first_name'],0,1)).ucfirst($request_data['last_name']);
        $user_data['email'] = $request_data['email'];
        $user_data['phone'] = $request_data['email'];
