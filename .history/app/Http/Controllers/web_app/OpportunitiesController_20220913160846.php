...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
         ...
         */
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->orderByUniqueViews('desc', Period::pastDays(30))->orderByViews('desc', Period::pastDays(30))->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(9);
        //$popular_listings = Opportunity::orderByUniqueViews('desc', Period::pastDays(30))->orderByViews('desc', Period::pastDays(30))->get();  // we are getting views and unique views
        //dd($popular_listings);
        //$all_opportunities = Opportunity::all();

        //return all opportunities view
        return view('web-app.opportunities.all_opportunities', compact(['all_countries', 'all_categories', 'all_opportunities', 'popular_listings']));
    }
    ...
    public function myOpportunities()
    {
        ...
        $all_opportunities = Opportunity::whereIn('user_id', $user)->with(['opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->latest()->paginate(6);
