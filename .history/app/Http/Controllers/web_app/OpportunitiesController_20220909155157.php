...
class OpportunitiesController extends Controller
{
    ...
    public function follow_opportunity(Request $request)
    {
        //1. check if this user email already exists
        $user_email = OpportunityFollowing::where('user_id', $request['user_id'])->where('opportunity_id', $request['opportunity_id'])->first();

        //return response
        return response()->json(['success' => 'A success follower']);
