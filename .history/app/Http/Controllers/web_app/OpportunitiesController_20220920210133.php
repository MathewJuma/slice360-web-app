...
class OpportunitiesController extends Controller
{
    ...
    public function adminFetchOpportunities(Request $request)
    {
        ...
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->whereRaw('funding_status != "funding closed"')->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->get();

        return response()->json(['success' => 'About to pull form data']);
    }
