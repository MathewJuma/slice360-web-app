...
class OpportunitiesController extends Controller
{
    ...
    public function adminFetchOpportunities()
    {
        ...
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->paginate(2, '*', 'slice360-opportunities')->onEachSide(5);
