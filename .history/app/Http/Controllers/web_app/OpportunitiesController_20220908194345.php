...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
         ...
         */
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images', 'opportunity_user_profile', 'opportunity_user_profile_banner', 'opportunity_user_profile_image'])->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(1);
