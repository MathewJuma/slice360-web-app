...
class OpportunitiesController extends Controller
{
    ...
    public function storeOpportunity(Request $request)
    {
        ...
        if ($request->hasFile('opportunity_images')) {
            ...
            $image_settings = [
                ...
                'image_height' => 800,
                'image_width' => 530,
                'table_relationship' => 'opportunity_images'
            ];
    ...
    public function showOpportunity(Opportunity $opportunity)
    {
        ...
        //assign $opportunity to opportunity_details for easy reading
        $opportunity_details = $opportunity;

        dd($opportunity_details->opportunity_banner_images);

        //fetch data related to this opportunity
