...
class OpportunitiesController extends Controller
{
    ...
    public function adminFetchOpportunities(Request $request)
    {
        ...
        if ($request->filled('search')) {
            ...
            $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->search($request->search)->paginate(10, 'slice360-opportunities'); // search by value
