...
class Slice360BlogController extends Controller
{
    ...
    public function listBlogs()
    {
        ...
        $blog_posts = WinkPost::with(['tags'])->orderBy('publish_date', 'DESC')->simplePaginate(12);

        dd($blog_posts);

        return view('web-app.blog.index', compact(['all_countries', 'all_categories', 'blog_posts']));
    }
