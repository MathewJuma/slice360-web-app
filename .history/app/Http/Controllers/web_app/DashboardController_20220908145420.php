...
class DashboardController extends Controller
{
    ...
    public function updateUserProfile(Request $request, User $user)
    {
        ...
        if ($user_profile) {
            ...
            if ($request->hasFile('profile_banner')) {
                ...
                $image_settings = [
                    'file_name' => $request_data['first_name'].'_profile_banner',
            ...
            if ($request->hasFile('profile_image')) {
                ...
                $image_settings = [
                    'file_name' => $request_data['first_name'].'_profile_image',
    ...
    protected function processProfileImages($request, $new_opportuntiy, array $image_settings)
    {
