...
class DashboardController extends Controller
{
    ...
    public function updateUserProfile(Request $request, User $user)
    {
        ...
        $user_profile->second_email = $request->second_email;
        $user_profile->second_phone = $request->second_phone;
        $user_profile->first_address = $request->first_address;
        $user_profile->second_address = $request->second_address;
        $user_profile->city = $request->city;
        $user_profile->country_id = $request->country_id;
        $user_profile->brief_description = $request->brief_description;
        $user_profile->website_url = $request->webiste;
