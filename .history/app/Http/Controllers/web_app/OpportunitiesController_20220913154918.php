...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
        ...
        $popular_listings = Opportunity::orderByUniqueViews('desc', Period::pastDays(10), 'opportunity_category')->orderByViews('desc', Period::pastDays(10))->get();  // descending; // descending
        dd($popular_listings);
    ...
    public function showOpportunity(Request $request, Opportunity $opportunity)
    {
        ...
        views($opportunity)->cooldown($expiresAt)->record();
