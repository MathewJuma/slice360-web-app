...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
         ...
         */
        //$all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images', 'opportunity_user_profile', 'opportunity_user_profile_banner', 'opportunity_user_profile_image'])->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(9);
        //$all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_user_profile', 'opportunity_user_profile_banner', 'opportunity_user_profile_image'])->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(9);
        ...
        foreach($all_opportunities as $opportunity){
            ...
            if(isset($opportunity->opportunity_user->user_profile->second_email)){
                echo $opportunity->opportunity_user->user_profile->second_email.'<br>';
            }else{
