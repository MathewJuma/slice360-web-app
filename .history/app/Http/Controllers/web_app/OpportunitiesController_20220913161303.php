...
class OpportunitiesController extends Controller
{
    ...
    public function listOpportunities()
    {
         ...
         */
        $views_period = Period::since(Carbon::create(2017));
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->orderByViews('desc', $views_period)->latest()->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(9);
