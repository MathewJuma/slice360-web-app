...
class OpportunitiesController extends Controller
{
    ...
    {
        //1. before showing an opportunity, set cookies to track viewers
        ...
        //2. process all countries and categories
        $all_countries = $this->all_countries;
        $all_categories = $this->all_categories;

        //3. Validate that cookie has been set to determine if view count is valid
        if(Cookie::get($cookie_name) == ''){//check if cookie is set
            ...
            //3.3 process opportunity details
            $opportunity_details = $this->processOpportunityDetails();
