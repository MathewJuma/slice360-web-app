...
class DashboardController extends Controller
{
    ...
    public function updateUserProfile(Request $request, User $user)
    {
        ...
        $user_data['first_name'] = $request_data['xxxxx'];
        $user_data['middle_name'] = $request_data['xxxxx'];
        $user_data['last_name'] = $request_data['xxxxx'];
        $user_data['username'] = $request_data['xxxxx'];
        $user_data['email'] = $request_data['xxxxx'];
