...
class OpportunitiesController extends Controller
{
    ...
    public function followOpportunity(Request $request)
    {
        ...
        if ($opportunity_following) {
            ...
            //return response
            return response()->json(['exists' => 'A you already following this opportunity.']);
        }
    ...
    public function unfollowOpportunity(Request $request)
    {
        ...
        if ($opportunity_following) {
            ...
            //delete actual opportunity
            $opportunity_following->delete();
        ...
        //3. save following, login the user then return success message
            ...
            //return response
            return response()->json(['not_exists' => 'Now following this opportunity.']);
        }
