...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $popular_categories = Category::withCount(['category_opportunities' => function ($query) {$query->whereRaw('funding_status != "funding closed"');}])->orderBy('category_opportunities_count', 'desc')->paginate(8, '*', 'popular-opportunitoes');
