...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        dd($popular_opportunities->where('views_count', '!=', '0')->orderByViews('desc', $views_period)->orderByUniqueViews('desc', $views_period)->latest()->take(50)->paginate(8, '*', 'popular-opportunitoes'));
