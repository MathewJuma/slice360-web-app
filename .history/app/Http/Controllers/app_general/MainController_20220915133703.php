...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $popular_opportunities = Opportunity::select('id','title')->where('viewable_type = "App\Models\web_app\Opportunity"')->orderByViews('desc', $views_period)->orderByUniqueViews('desc', $views_period)->latest()->paginate(8);
