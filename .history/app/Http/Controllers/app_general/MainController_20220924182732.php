...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        //popular categories
        $popular_categories = Category::withCount(['category_opportunities' => function ($query) {$query->whereRaw('funding_status != "funding closed"')->whereRaw('is_published = "Yes"');}])->orderBy('category_opportunities_count', 'desc')->paginate(6, '*', 'popular-categories');
