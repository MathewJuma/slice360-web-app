...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $all_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->orderByViews('desc', $views_period)->orderByUniqueViews('desc', $views_period)->filter(request(['tag', 'interest', 'country_id', 'category_id']))->paginate(8);
