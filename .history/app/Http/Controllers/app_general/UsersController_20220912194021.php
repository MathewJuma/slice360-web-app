...
class UsersController extends Controller
{
    ...
    public function submitTestimonial(Request $request)
    {
        ...
        if ($user_testimonial) {
            ...
            $user_testimonial->opportunity_location = $request['opportunity_location'];
    ...
    public function getIntouchMessage(Request $request)
    {
        ...
        $intouch_message->first_name = $request['first_name'];
        $intouch_message->last_name = $request['last_name'];
        $intouch_message->email = $request['email'];
        $intouch_message->email = $request['email'];
