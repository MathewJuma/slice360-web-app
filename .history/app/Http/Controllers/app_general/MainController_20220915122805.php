...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $funded_opportunities = count(Opportunity::select('*')->whereRaw('amount_needed = amount_raised')->get());
        dd($new_weekly_visitors);

        return view('app-general.index', compact(['all_countries', 'all_categories', 'all_opportunities', 'testimonials', 'new_monthly_opportunities', 'new_monthly_visitors']));
    }
