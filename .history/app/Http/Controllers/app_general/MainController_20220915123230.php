...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $sum_funded_opportunities = count(Opportunity::select('*')->whereRaw('amount_needed = amount_raised')->sum('amount_raised')->get());
        dd($sum_funded_opportunities);

        return view('app-general.index', compact(['all_countries', 'all_categories', 'all_opportunities', 'testimonials', 'new_monthly_opportunities', 'new_monthly_visitors', 'fully_funded_opportunities']));
    }
