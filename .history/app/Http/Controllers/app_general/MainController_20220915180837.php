...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $popular_categories = Category::with(['category_opportunities'])->withCount('category_opportunities')->whereRaw('funding_status != "funding closed"')->orderBy('category_opportunities_count', 'desc')->take(6)->get();
