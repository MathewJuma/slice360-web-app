...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $popular_opportunities = Opportunity::with(['opportunity_user', 'opportunity_country', 'opportunity_category', 'opportunity_banner_images', 'opportunity_other_images'])->orderByViews('desc', $views_period)->orderByUniqueViews('desc', $views_period)->where('views', 0)->latest()->take(50)->paginate(8, '*', 'popular-opportunitoes');
