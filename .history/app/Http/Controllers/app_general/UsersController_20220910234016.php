...
class UsersController extends Controller
{
    ...
    public function followUser(Request $request)
    {
        ...
        $user_following = UserFollowing::where('followed_by_id', $request['followed_by_id'])->where('followed_id', $request['followed_id'])->first();
        ...
        if ($user_following) {
            ...
            $user_following->followed_id = $request['followed_id'];
            ...
            //return response
            return response()->json(['success' => 'A you are already following this user.']);
        }
    ...
    {
        //1. check if this following already exists
        $user_following = UserFollowing::where('user_id', $request['user_id'])->where('opportunity_id', $request['opportunity_id'])->first();
